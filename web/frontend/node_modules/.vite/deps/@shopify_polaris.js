...
function useIsAfterInitialMount() {
  const [isAfterInitialMount, setIsAfterInitialMount] = (0, import_react21.useState)(false);
...
function Spinner({
  ...
  const spinnerSVGMarkup = size === "large" ? import_react23.default.createElement("svg", {
    viewBox: "0 0 44 44",
  ...
  const accessibilityLabelMarkup = (isAfterInitialMount || !hasFocusableParent) && import_react23.default.createElement(VisuallyHidden, null, accessibilityLabel);
  return import_react23.default.createElement(import_react23.default.Fragment, null, import_react23.default.createElement("span", {
    className
  }, spinnerSVGMarkup), import_react23.default.createElement("span", spanAttributes, accessibilityLabelMarkup));
}
...
function usePortalsManager() {
  const portalsManager = (0, import_react24.useContext)(PortalsManagerContext);
  if (!portalsManager) {
...
function useUniqueId(prefix = "", overrideId = "") {
  const idFactory = (0, import_react25.useContext)(UniqueIdFactoryContext);
  const uniqueIdRef = (0, import_react25.useRef)(null);
  if (!idFactory) {
...
function Portal({
  ...
  return container ? (0, import_react_dom.createPortal)(import_react26.default.createElement("div", {
...
function wrapWithComponent(element, Component9, props) {
  ...
  return isElementOfType(element, Component9) ? element : import_react27.default.createElement(Component9, props, element);
}
...
function isElementOfType(element, Component9) {
  var _element$props;
  if (element == null || !(0, import_react27.isValidElement)(element) || typeof element.type === "string") {
    return false;
  }
  const {
    type: defaultType
...
function elementChildren(children2, predicate = () => true) {
  return import_react27.Children.toArray(children2).filter((child) => (0, import_react27.isValidElement)(child) && predicate(child));
}
...
function KeypressListener({
  ...
  const tracked = (0, import_react29.useRef)({
    handler,
    keyCode
  });
  ...
  const handleKeyEvent = (0, import_react29.useCallback)((event) => {
    const {
      handler: handler2,
      keyCode: keyCode2
    } = tracked.current;
...
var ScrollableContext = (0, import_react30.createContext)(void 0);
...
function ScrollTo() {
  const anchorNode = (0, import_react31.useRef)(null);
  const scrollToPosition = (0, import_react31.useContext)(ScrollableContext);
  ...
  return import_react31.default.createElement("a", {
    id,
    ref: anchorNode
  });
}
...
var Scrollable = class extends import_react32.Component {
  constructor(...args) {
    super(...args);
    this.state = {
      topShadow: false,
  ...
  render() {
    ...
    return import_react32.default.createElement(ScrollableContext.Provider, {
      value: this.scrollToPosition
    }, import_react32.default.createElement(StickyManagerContext.Provider, {
      value: this.stickyManager
    }, import_react32.default.createElement("div", Object.assign({
...
var PositionedOverlay = class extends import_react33.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      measuring: true,
  ...
  render() {
    ...
    return import_react33.default.createElement("div", {
      ...
      style,
      ref: this.setOverlay
    }, import_react33.default.createElement(EventListener, {
      event: "resize",
...
function Pane({
  ...
  return fixed ? import_react35.default.createElement("div", {
    style,
    className
  }, content) : import_react35.default.createElement(Scrollable, {
    shadow: true,
    className,
    style,
    onScrolledToBottom
...
var PopoverOverlay = class extends import_react36.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      transitionStatus: this.props.active ? TransitionStatus.Entering : TransitionStatus.Exited
    };
    this.contentNode = (0, import_react36.createRef)();
    ...
    this.renderPopover = (overlayDetails) => {
      ...
      const content = import_react36.default.createElement("div", {
        id,
      ...
      return import_react36.default.createElement("div", Object.assign({
        className
      }, overlay.props), import_react36.default.createElement(EventListener, {
        event: "click",
        handler: this.handleClick
      }), import_react36.default.createElement(EventListener, {
        event: "touchstart",
        handler: this.handleClick
      }), import_react36.default.createElement(KeypressListener, {
        keyCode: Key.Escape,
      ...
      }), import_react36.default.createElement(CustomProperties, {
        colorScheme
      }, import_react36.default.createElement("div", {
        className: styles6.Wrapper
      }, content)), import_react36.default.createElement("div", {
        className: styles6.FocusTracker,
        tabIndex: 0,
    ...
    this.overlayRef = (0, import_react36.createRef)();
  }
  forceUpdatePosition() {
  ...
  render() {
    ...
    return import_react36.default.createElement(PositionedOverlay, {
      ref: this.overlayRef,
      fullWidth,
      active,
      activator,
...
function renderPopoverContent(children2, props) {
  const childrenArray = import_react36.Children.toArray(children2);
...
// node_modules/@shopify/polaris/build/esm/components/Popover/Popover.js
var PopoverComponent = (0, import_react37.forwardRef)(function Popover({
  ...
  const [activatorNode, setActivatorNode] = (0, import_react37.useState)();
  const overlayRef = (0, import_react37.useRef)(null);
  const activatorContainer = (0, import_react37.useRef)(null);
  ...
  const setAccessibilityAttributes = (0, import_react37.useCallback)(() => {
  ...
  const portal2 = activatorNode ? import_react37.default.createElement(Portal, {
    idPrefix: "popover"
  }, import_react37.default.createElement(PopoverOverlay, Object.assign({
    ref: overlayRef,
    id,
  ...
  return import_react37.default.createElement(WrapperComponent, {
    ref: activatorContainer
  }, import_react37.Children.only(activator), portal2);
});
...
function TextStyle({
  ...
  return import_react38.default.createElement(Element2, {
    className
  }, children2);
}
...
var WithinFilterContext = (0, import_react39.createContext)(false);
...
function useI18n() {
  const i18n = (0, import_react40.useContext)(I18nContext);
  if (!i18n) {
...
function Pip({
  ...
  return import_react41.default.createElement("span", {
    className
  }, import_react41.default.createElement(VisuallyHidden, null, accessibilityLabel));
}
...
function Icon({
  ...
  const contentMarkup = {
    function: import_react42.default.createElement(SourceComponent, {
      className: styles13.Svg,
      focusable: "false",
      "aria-hidden": "true"
    }),
    placeholder: import_react42.default.createElement("div", {
      className: styles13.Placeholder
    }),
    external: import_react42.default.createElement("img", {
  ...
  return import_react42.default.createElement("span", {
    className
  }, import_react42.default.createElement(VisuallyHidden, null, accessibilityLabel), contentMarkup[sourceType]);
}
...
function Badge({
  ...
  const i18n = useI18n();
  const withinFilter = (0, import_react43.useContext)(WithinFilterContext);
  ...
  let accessibilityMarkup = Boolean(accessibilityLabel) && import_react43.default.createElement(VisuallyHidden, null, accessibilityLabel);
  if (progress && !icon) {
    accessibilityMarkup = import_react43.default.createElement("span", {
      className: styles11.PipContainer
    }, import_react43.default.createElement(Pip, {
      progress,
      status,
  ...
  return import_react43.default.createElement("span", {
    className
  }, accessibilityMarkup, icon && import_react43.default.createElement("span", {
    className: styles11.Icon
  }, import_react43.default.createElement(Icon, {
    source: icon
  })), children2 && import_react43.default.createElement("span", null, children2));
}
Badge.Pip = Pip;
...
// node_modules/@shopify/polaris/build/esm/components/UnstyledLink/UnstyledLink.js
var UnstyledLink = (0, import_react45.memo)((0, import_react45.forwardRef)(function UnstyledLink2(props, _ref) {
  const LinkComponent = useLink();
  if (LinkComponent) {
    return import_react45.default.createElement(LinkComponent, Object.assign({}, unstyled.props, props));
  }
  const {
    external,
    url,
  ...
  return import_react45.default.createElement("a", Object.assign({
    target
  }, rest, {
    href: url,
    rel
...
function Item({
  ...
  if (prefix) {
    prefixMarkup = import_react46.default.createElement("span", {
  ...
  const contentMarkup = helpText ? import_react46.default.createElement("span", {
    className: styles9.ContentBlock
  }, import_react46.default.createElement("span", {
    className: styles9.ContentBlockInner
  }, contentText), import_react46.default.createElement(TextStyle, {
    variation: "subdued"
  }, helpText)) : contentText;
  const badgeMarkup = badge && import_react46.default.createElement("span", {
    className: styles9.Suffix
  }, import_react46.default.createElement(Badge, {
    status: badge.status
  }, badge.content));
  const suffixMarkup = suffix && import_react46.default.createElement("span", {
    className: styles9.Suffix
  }, suffix);
  const textMarkup = import_react46.default.createElement("span", {
    className: styles9.Text
  }, contentMarkup);
  const contentElement = import_react46.default.createElement("span", {
    className: styles9.Content
  }, prefixMarkup, textMarkup, badgeMarkup, suffixMarkup);
  const scrollMarkup = active ? import_react46.default.createElement(Scrollable.ScrollTo, null) : null;
  const control = url ? import_react46.default.createElement(UnstyledLink, {
    id,
    ...
    role
  }, contentElement) : import_react46.default.createElement("button", {
    id,
    type: "button",
    className,
    disabled,
  ...
  return import_react46.default.createElement(import_react46.default.Fragment, null, scrollMarkup, control);
}
...
function Section2({
  ...
  const actionMarkup = section.items.map(({
    ...
    }, import_react47.default.createElement(Item, Object.assign({
      content,
      helpText,
      role: actionRole,
  ...
  const titleMarkup = section.title ? import_react47.default.createElement("p", {
  ...
  const sectionMarkup = import_react47.default.createElement("div", {
    className
  }, titleMarkup, import_react47.default.createElement("ul", {
    className: styles9.Actions,
    role: sectionRole,
    tabIndex: !hasMultipleSections ? -1 : void 0
  }, actionMarkup));
  return hasMultipleSections ? import_react47.default.createElement("li", {
...
function ActionList({
  ...
  let finalSections = [];
  const actionListRef = (0, import_react48.useRef)(null);
  if (items) {
    finalSections = [{
      items
    }, ...sections];
  ...
  const sectionMarkup = finalSections.map((section, index) => {
    return section.items.length > 0 ? import_react48.default.createElement(Section2, {
  ...
  const listeners = actionRole === "menuitem" ? import_react48.default.createElement(import_react48.default.Fragment, null, import_react48.default.createElement(KeypressListener, {
    keyEvent: "keydown",
    keyCode: Key.DownArrow,
    handler: handleFocusNextItem
  }), import_react48.default.createElement(KeypressListener, {
    keyEvent: "keydown",
    keyCode: Key.UpArrow,
    handler: handleFocusPreviousItem
  })) : null;
  return import_react48.default.createElement(Element2, {
    ref: actionListRef,
    className,
    role: elementRole,
...
function UnstyledButton({
  ...
  if (url) {
    buttonMarkup = disabled ? import_react49.default.createElement("a", commonProps, children2) : import_react49.default.createElement(UnstyledLink, Object.assign({}, interactiveProps, {
      url,
      external,
      download
    }, rest), children2);
  } else {
    buttonMarkup = import_react49.default.createElement("button", Object.assign({}, interactiveProps, {
...
function Button({
  ...
  const disclosureMarkup = disclosure ? import_react50.default.createElement("span", {
  ...
  const iconSource = isIconSource(icon) ? import_react50.default.createElement(Icon, {
    source: loading ? "placeholder" : icon
  }) : icon;
  const iconMarkup = iconSource ? import_react50.default.createElement("span", {
    className: classNames(styles3.Icon, loading && styles3.hidden)
  }, iconSource) : null;
  const childMarkup = children2 ? import_react50.default.createElement("span", {
    className: classNames(styles3.Text, removeUnderline && styles3.removeUnderline),
    key: disabled ? "text-disabled" : "text"
  }, children2) : null;
  const spinnerSVGMarkup = loading ? import_react50.default.createElement("span", {
    className: styles3.Spinner
  }, import_react50.default.createElement(Spinner, {
    size: "small",
    accessibilityLabel: i18n.translate("Polaris.Button.spinnerAccessibilityLabel")
  })) : null;
  const [disclosureActive, setDisclosureActive] = (0, import_react50.useState)(false);
  const toggleDisclosureActive = (0, import_react50.useCallback)(() => {
  ...
  if (connectedDisclosure) {
    ...
    const connectedDisclosureActivator = import_react50.default.createElement("button", {
      type: "button",
    ...
    connectedDisclosureMarkup = import_react50.default.createElement(Popover2, {
      active: disclosureActive,
      onClose: toggleDisclosureActive,
      activator: connectedDisclosureActivator,
      preferredAlignment: "right"
    }, import_react50.default.createElement(ActionList, {
  ...
  const buttonMarkup = import_react50.default.createElement(UnstyledButton, Object.assign({}, commonProps, linkProps, actionProps), import_react50.default.createElement("span", {
    className: styles3.Content
  }, spinnerSVGMarkup, iconMarkup, childMarkup, disclosureMarkup));
  return connectedDisclosureMarkup ? import_react50.default.createElement("div", {
...
function buttonFrom({
  ...
  return import_react51.default.createElement(Button, Object.assign({
    key,
    onClick: onAction
...
function ButtonGroup({
  ...
  const contents = elementChildren(children2).map((child, index) => import_react53.default.createElement(Item2, {
    button: child,
    key: index
  }));
...
// node_modules/@shopify/polaris/build/esm/components/Stack/Stack.js
var Stack = (0, import_react55.memo)(function Stack2({
  children: children2,
  vertical,
  spacing: spacing2,
  distribution,
...
function Heading({
  ...
  return import_react56.default.createElement(Element2, {
...
function Header({
  ...
  const actionMarkup = actions ? import_react57.default.createElement(ButtonGroup, null, buttonsFrom(actions, {
    plain: true
  })) : null;
  const titleMarkup = (0, import_react57.isValidElement)(title) ? title : import_react57.default.createElement(Heading, null, title);
  const headingMarkup = actionMarkup || children2 ? import_react57.default.createElement(Stack, {
    alignment: "baseline"
  }, import_react57.default.createElement(Stack.Item, {
    fill: true
...
function Section3({
  ...
  const titleMarkup = typeof title === "string" ? import_react59.default.createElement(Subheading, null, title) : title;
  const titleAreaMarkup = titleMarkup || actionMarkup ? import_react59.default.createElement("div", {
    className: styles2.SectionHeader
  }, actionMarkup ? import_react59.default.createElement(Stack, {
    alignment: "baseline"
...
var Card = function Card2({
  ...
  const headerMarkup = title || actions ? import_react61.default.createElement(Header, {
    actions,
    title
  }) : null;
  const content = sectioned ? import_react61.default.createElement(Section3, null, children2) : children2;
  ...
  if (secondaryFooterActions && secondaryFooterActions.length) {
    if (secondaryFooterActions.length === 1) {
      ...
      secondaryFooterActionsMarkup = import_react61.default.createElement(import_react61.default.Fragment, null, import_react61.default.createElement(Popover2, {
        active: secondaryActionsPopoverOpen,
        activator: import_react61.default.createElement(Button, {
          disclosure: true,
      ...
      }, import_react61.default.createElement(ActionList, {
        items: secondaryFooterActions
      })));
    }
  }
  const footerMarkup = primaryFooterActionMarkup || secondaryFooterActionsMarkup ? import_react61.default.createElement("div", {
    className: classNames(styles2.Footer, footerActionAlignment === "left" && styles2.LeftJustified)
  }, footerActionAlignment === "right" ? import_react61.default.createElement(ButtonGroup, null, secondaryFooterActionsMarkup, primaryFooterActionMarkup) : import_react61.default.createElement(ButtonGroup, null, primaryFooterActionMarkup, secondaryFooterActionsMarkup)) : null;
  return import_react61.default.createElement(WithinContentContext.Provider, {
    value: true
...
function SettingAction({
  ...
  }, children2), import_react62.default.createElement("div", {
...
function Image({
  ...
  return import_react63.default.createElement("img", Object.assign({
    alt,
    src: source,
    crossOrigin,
    className,
...
function Avatar({
  ...
  const [status, setStatus] = (0, import_react64.useState)(Status.Pending);
  ...
  const imageMarkUp = source && isAfterInitialMount && status !== Status.Errored ? import_react64.default.createElement(Image, {
  ...
  const avatarBody = customer || !initials ? import_react64.default.createElement("path", {
    fill: "currentColor",
  ...
  const svgMarkup = hasImage ? null : import_react64.default.createElement("span", {
    className: styles19.Initials
  }, import_react64.default.createElement("svg", {
    className: styles19.Svg,
    viewBox: "0 0 40 40"
  }, avatarBody));
  return import_react64.default.createElement("span", {
    "aria-label": label,
    role: "img",
    className
...
function AccountConnection({
  ...
  const avatarMarkup = connected ? import_react65.default.createElement(Avatar, {
    accessibilityLabel: "",
    name: accountName,
    initials,
    source: avatarUrl
  ...
  if (title) {
    titleMarkup = import_react65.default.createElement("div", null, title);
  } else if (accountName) {
    titleMarkup = import_react65.default.createElement("div", null, accountName);
  }
  const detailsMarkup = details ? import_react65.default.createElement("div", null, import_react65.default.createElement(TextStyle, {
    variation: "subdued"
  }, details)) : null;
  const termsOfServiceMarkup = termsOfService ? import_react65.default.createElement("div", {
    className: styles.TermsOfService
  }, termsOfService) : null;
  const actionElement = action ? buttonFrom(action, {
    primary: !connected
  }) : null;
  return import_react65.default.createElement(Card, {
    sectioned: true
  }, import_react65.default.createElement(SettingAction, {
    action: actionElement
  }, import_react65.default.createElement(Stack, null, avatarMarkup, import_react65.default.createElement(Stack.Item, {
    fill: true
...
function RollupActions({
  ...
  const activatorMarkup = import_react66.default.createElement("div", {
  ...
  return import_react66.default.createElement(Popover2, {
    active: rollupOpen,
    activator: activatorMarkup,
    preferredAlignment: "right",
    onClose: toggleRollupOpen,
    hideOnPrint: true
  }, import_react66.default.createElement(ActionList, {
    items,
    sections,
...
function SecondaryAction({
  ...
  const secondaryActionsRef = (0, import_react67.useRef)(null);
  ...
  }, import_react67.default.createElement(Button, Object.assign({
    onClick: onAction
  }, rest), children2));
}
...
function MenuGroup({
  ...
  const handleOpen = (0, import_react68.useCallback)(() => {
    onOpen(title);
  }, [onOpen, title]);
  ...
  const handleOffsetWidth = (0, import_react68.useCallback)((width) => {
    if (!getOffsetWidth)
      return;
    getOffsetWidth(width);
  }, [getOffsetWidth]);
  const popoverActivator = import_react68.default.createElement(SecondaryAction, {
    disclosure: true,
    disabled,
    icon,
    accessibilityLabel,
  ...
  }), details && import_react68.default.createElement("div", {
...
function Actions({
  ...
  const i18n = useI18n();
  const actionsLayoutRef = (0, import_react69.useRef)(null);
  const menuGroupWidthRef = (0, import_react69.useRef)(0);
  const availableWidthRef = (0, import_react69.useRef)(0);
  const actionsAndGroupsLengthRef = (0, import_react69.useRef)(0);
  const timesMeasured = (0, import_react69.useRef)(0);
  const actionWidthsRef = (0, import_react69.useRef)([]);
  const rollupActiveRef = (0, import_react69.useRef)(null);
  const [activeMenuGroup, setActiveMenuGroup] = (0, import_react69.useState)(void 0);
  const [measuredActions, setMeasuredActions] = (0, import_react69.useState)({
    showable: [],
    rolledUp: []
  });
  ...
  const handleActionsOffsetWidth = (0, import_react69.useCallback)((width) => {
    actionWidthsRef.current = [...actionWidthsRef.current, width];
  }, []);
  const handleMenuGroupToggle = (0, import_react69.useCallback)((group) => setActiveMenuGroup(activeMenuGroup ? void 0 : group), [activeMenuGroup]);
  const handleMenuGroupClose = (0, import_react69.useCallback)(() => setActiveMenuGroup(void 0), []);
  const updateActions = (0, import_react69.useCallback)(() => {
  ...
  const measureActions = (0, import_react69.useCallback)(() => {
  ...
  const handleResize = (0, import_react69.useMemo)(() => debounce(() => {
  ...
  const actionsMarkup = actions.map((action) => {
    ...
    return import_react69.default.createElement(SecondaryAction, Object.assign({
      key: content,
      onClick: onAction
    }, rest, {
  ...
  const rollUppableActionsMarkup = measuredActions.showable.length > 0 ? measuredActions.showable.map((action) => action.content && import_react69.default.createElement(SecondaryAction, Object.assign({
    key: action.content
  }, action, {
    getOffsetWidth: handleActionsOffsetWidth
  }), action.content)) : null;
  ...
  const groupsMarkup = filteredGroups.map((group) => {
    ...
    if (!isDefaultGroup && !isLastMenuGroup) {
      return import_react69.default.createElement(MenuGroup, Object.assign({
        key: title,
        title,
  ...
  const groupedActionsMarkup = import_react69.default.createElement(ButtonGroup, {
    spacing: "extraTight"
  ...
  }, groupedActionsMarkup, import_react69.default.createElement(EventListener, {
    event: "resize",
    handler: handleResize
  }));
}
...
function ActionMenu({
  ...
  }, rollup ? import_react70.default.createElement(RollupActions, {
    accessibilityLabel: rollupActionsLabel,
    items: actions,
    sections: rollupSections
  }) : import_react70.default.createElement(Actions, {
    actions,
    groups,
    onActionRollup
  }));
...
var ComboboxTextFieldContext = (0, import_react71.createContext)(void 0);
var ComboboxListboxContext = (0, import_react71.createContext)({});
var ComboboxListboxOptionContext = (0, import_react71.createContext)({});

// node_modules/@shopify/polaris/build/esm/utilities/combobox/hooks.js
function useComboboxTextField() {
  const context = (0, import_react72.useContext)(ComboboxTextFieldContext);
  if (!context) {
...
function useComboboxListbox() {
  const context = (0, import_react72.useContext)(ComboboxListboxContext);
  return context;
}
...
var ListboxContext = (0, import_react73.createContext)(void 0);
var WithinListboxContext = (0, import_react73.createContext)(false);
var ActionContext = (0, import_react73.createContext)(false);
...
function Choice({
  ...
  const labelMarkup = import_react75.default.createElement("label", {
    className,
    htmlFor: id,
    onClick,
    onMouseOver,
  ...
  }, children2), import_react75.default.createElement("span", {
    className: styles30.Label
  }, label));
  const helpTextMarkup = helpText ? import_react75.default.createElement("div", {
    className: styles30.HelpText,
    id: helpTextID(id)
  }, helpText) : null;
  const errorMarkup = error && typeof error !== "boolean" && import_react75.default.createElement("div", {
    className: styles30.Error
  }, import_react75.default.createElement(InlineError, {
    message: error,
    fieldID: id
  }));
  const descriptionMarkup = helpTextMarkup || errorMarkup ? import_react75.default.createElement("div", {
    className: styles30.Descriptions
  }, errorMarkup, helpTextMarkup) : null;
  return descriptionMarkup ? import_react75.default.createElement("div", null, labelMarkup, descriptionMarkup) : labelMarkup;
}
...
// node_modules/@shopify/polaris/build/esm/components/Checkbox/Checkbox.js
var Checkbox = (0, import_react76.forwardRef)(function Checkbox2({
  ariaControls,
  ...
  const inputNode = (0, import_react76.useRef)(null);
  ...
  const [keyFocused, setKeyFocused] = (0, import_react76.useState)(false);
  const isWithinListbox = (0, import_react76.useContext)(WithinListboxContext);
  ...
  return import_react76.default.createElement(Choice, {
    id,
    label,
    labelHidden,
    helpText,
  ...
  }, import_react76.default.createElement("input", Object.assign({
    ref: inputNode,
    id,
    name,
    value,
  ...
  }, indeterminateAttributes)), import_react76.default.createElement("span", {
    className: backdropClassName,
    onClick: stopPropagation,
    onKeyUp: stopPropagation
  }), import_react76.default.createElement("span", {
    className: styles29.Icon
  }, import_react76.default.createElement(Icon, {
    source: iconSource
  }))));
});
function noop3() {
...
// node_modules/@shopify/polaris/build/esm/components/Listbox/components/TextOption/TextOption.js
var TextOption = (0, import_react77.memo)(function TextOption2({
  children: children2,
  selected,
  disabled
}) {
  const {
    allowMultiple
  } = (0, import_react77.useContext)(ComboboxListboxOptionContext);
  const isAction = (0, import_react77.useContext)(ActionContext);
  ...
  }, allowMultiple && !isAction ? import_react77.default.createElement("div", {
    className: styles28.Checkbox
  }, import_react77.default.createElement(Checkbox, {
    disabled,
    checked: selected,
    label: children2
  })) : children2));
...
function useListbox() {
  const listbox = (0, import_react78.useContext)(ListboxContext);
  if (!listbox) {
...
// node_modules/@shopify/polaris/build/esm/components/Listbox/components/Loading/Loading.js
var Loading = (0, import_react79.memo)(function LoadingOption({
  children: children2,
  ...
  return import_react79.default.createElement("li", {
    className: styles32.ListItem,
    role: "presentation"
  }, children2 ? children2 : import_react79.default.createElement("div", {
    className: styles32.Loading
  }, import_react79.default.createElement(Spinner, {
    size: "small",
    accessibilityLabel: label
  })));
});
...
var SectionContext = (0, import_react80.createContext)(null);
...
function Section4({
  ...
  return import_react81.default.createElement(SectionContext.Provider, {
    value: sectionId
  }, import_react81.default.createElement("li", Object.assign({
    role: "presentation"
  }, listboxSectionDataSelector.props), title, import_react81.default.createElement("ul", {
    role: "group",
...
function useSection() {
  const context = (0, import_react82.useContext)(SectionContext);
  return context;
}
...
function Header2({
  ...
  const content = typeof children2 === "string" ? import_react83.default.createElement("div", {
...
var MappedActionContext = (0, import_react84.createContext)({});

// node_modules/@shopify/polaris/build/esm/components/Listbox/components/Option/Option.js
var Option = (0, import_react85.memo)(function Option2({
  value,
  children: children2,
  selected,
  disabled = false,
  ...
  const {
    ...
    onAction,
    destructive
  } = (0, import_react85.useContext)(MappedActionContext);
  const listItemRef = (0, import_react85.useRef)(null);
  const domId = useUniqueId("ListboxOption");
  const sectionId = useSection();
  const isWithinSection = Boolean(sectionId);
  const handleOptionSelect = (0, import_react85.useCallback)((event) => {
  ...
  const content = typeof children2 === "string" ? import_react85.default.createElement(TextOption, {
    selected,
    disabled
  }, children2) : children2;
  ...
  const contentMarkup = url ? import_react85.default.createElement(UnstyledLink, {
    url,
    external
  }, content) : content;
  return import_react85.default.createElement("li", Object.assign({}, sectionAttributes, {
...
function Action(props) {
  ...
  const iconMarkup = icon && import_react86.default.createElement("div", {
    className: styles35.Icon
  }, import_react86.default.createElement(Icon, {
    color: "subdued",
    source: icon
  }));
  const className = classNames(styles35.Action, divider && styles35.ActionDivider);
  return import_react86.default.createElement(ActionContext.Provider, {
    value: true
  }, import_react86.default.createElement(Option, props, import_react86.default.createElement("div", {
    className
  }, import_react86.default.createElement(TextOption, {
    selected,
    disabled
...
function Listbox({
  ...
  const [loading, setLoading] = (0, import_react87.useState)();
  const [activeOption, setActiveOption] = (0, import_react87.useState)();
  const [lazyLoading, setLazyLoading] = (0, import_react87.useState)(false);
  const [currentOptions, setCurrentOptions] = (0, import_react87.useState)([]);
  const {
  ...
  const listboxRef = (0, import_react87.useRef)(null);
  const {
    listboxId,
    textFieldLabelId,
    textFieldFocused,
  ...
  const getNavigableOptions = (0, import_react87.useCallback)(() => {
    if (!listboxRef.current) {
      return [];
    }
    return [...new Set(listboxRef.current.querySelectorAll(OPTION_SELECTOR))];
  }, []);
  const getFirstNavigableOption = (0, import_react87.useCallback)((currentOptions2) => {
  ...
  const handleScrollIntoView = (0, import_react87.useCallback)((option) => {
    const {
      current: scrollable2
    } = scrollableRef;
    if (scrollable2) {
  ...
  const handleKeyToBottom = (0, import_react87.useCallback)(() => {
    if (onKeyToBottom) {
      setLazyLoading(true);
      return Promise.resolve(onKeyToBottom());
    }
  }, [onKeyToBottom]);
  const handleChangeActiveOption = (0, import_react87.useCallback)((nextOption) => {
    if (!nextOption)
  ...
  const getFormattedOption = (0, import_react87.useCallback)((element, index) => {
    return {
      element,
      index,
      domId: element.id,
  ...
  const resetActiveOption = (0, import_react87.useCallback)(() => {
  ...
  (0, import_react87.useEffect)(() => {
    if (autoSelection !== AutoSelection.None && !loading && children2 && import_react87.Children.count(children2) > 0) {
      resetActiveOption();
    }
  ...
  const onOptionSelect = (0, import_react87.useCallback)((option) => {
  ...
  const getNextIndex = (0, import_react87.useCallback)((currentIndex, lastIndex, direction) => {
    let nextIndex;
    if (direction === "down") {
  ...
  const getNextValidOption = (0, import_react87.useCallback)(async (key) => {
  ...
  const handleArrow = (0, import_react87.useCallback)(async (type, event) => {
    event.preventDefault();
    const {
      element,
      nextIndex
  ...
  const handleDownArrow = (0, import_react87.useCallback)((event) => {
    handleArrow("down", event);
  }, [handleArrow]);
  const handleUpArrow = (0, import_react87.useCallback)((event) => {
    handleArrow("up", event);
  }, [handleArrow]);
  const handleEnter = (0, import_react87.useCallback)((event) => {
    event.preventDefault();
    event.stopPropagation();
    if (activeOption) {
  ...
  const handleBlur = (0, import_react87.useCallback)((event) => {
    event.stopPropagation();
  ...
  const listeners = keyboardEventsEnabled || textFieldFocused ? import_react87.default.createElement(import_react87.default.Fragment, null, import_react87.default.createElement(KeypressListener, {
    keyEvent: "keydown",
    keyCode: Key.DownArrow,
    handler: handleDownArrow
  }), import_react87.default.createElement(KeypressListener, {
    keyEvent: "keydown",
    keyCode: Key.UpArrow,
  ...
  const listboxContext = (0, import_react87.useMemo)(() => ({
    onOptionSelect,
    setLoading
  }), [onOptionSelect]);
  return import_react87.default.createElement(import_react87.default.Fragment, null, listeners, import_react87.default.createElement(VisuallyHidden, null, import_react87.default.createElement("div", {
    "aria-live": "polite"
  }, loading ? loading : null)), import_react87.default.createElement(ListboxContext.Provider, {
    value: listboxContext
  }, import_react87.default.createElement(WithinListboxContext.Provider, {
    value: true
  }, children2 ? import_react87.default.createElement("ul", {
    tabIndex: 0,
    role: "listbox",
...
// node_modules/@shopify/polaris/build/esm/components/Autocomplete/components/MappedOption/MappedOption.js
var MappedOption = (0, import_react88.memo)(function MappedOption2({
  label,
  value,
  disabled,
  media,
  ...
  const mediaMarkup = media ? import_react88.default.createElement("div", {
    className: mediaClassNames
  }, media) : null;
  const accessibilityLabel = typeof label === "string" ? label : void 0;
  return import_react88.default.createElement(Listbox.Option, {
    accessibilityLabel,
    key: value,
    selected,
    value,
    disabled
  }, import_react88.default.createElement(Listbox.TextOption, {
    selected,
    disabled
...
function Label({
  ...
  return import_react89.default.createElement("div", {
    className
  }, import_react89.default.createElement("label", {
    id: labelID(id),
    htmlFor: id,
...
function Labelled({
  ...
  const actionMarkup = action ? import_react90.default.createElement("div", {
  ...
  const labelMarkup = label ? import_react90.default.createElement("div", {
    className: styles39.LabelWrapper
  }, import_react90.default.createElement(Label, Object.assign({
    id,
    requiredIndicator
  }, rest, {
    hidden: false
...
function Connected({
  ...
  const leftConnectionMarkup = left ? import_react92.default.createElement(Item4, {
    position: "left"
  }, left) : null;
  const rightConnectionMarkup = right ? import_react92.default.createElement(Item4, {
    position: "right"
  }, right) : null;
  return import_react92.default.createElement("div", {
    className: styles41.Connected
  }, leftConnectionMarkup, import_react92.default.createElement(Item4, {
    position: "primary"
...
function Resizer({
  ...
  const minimumLinesMarkup = minimumLines ? import_react94.default.createElement("div", {
  ...
  }, import_react94.default.createElement(EventListener, {
    event: "resize",
...
function TextField({
  ...
  const prefixMarkup = prefix ? import_react95.default.createElement("div", {
    className: styles38.Prefix,
    id: `${id}-Prefix`,
    ref: prefixRef
  }, prefix) : null;
  const suffixMarkup = suffix ? import_react95.default.createElement("div", {
  ...
  if (showCharacterCount) {
    ...
    characterCountMarkup = import_react95.default.createElement("div", {
  ...
  const clearButtonMarkup = clearButton && clearButtonVisible ? import_react95.default.createElement("button", {
    type: "button",
    className: styles38.ClearButton,
    onClick: handleClearButtonPress,
    disabled
  }, import_react95.default.createElement(VisuallyHidden, null, i18n.translate("Polaris.Common.clear")), import_react95.default.createElement(Icon, {
    source: SvgCircleCancelMinor,
    color: "base"
  })) : null;
  const handleNumberChange = (0, import_react95.useCallback)((steps) => {
    if (onChange == null) {
      return;
    }
  ...
  const spinnerMarkup = type === "number" && step !== 0 && !disabled && !readOnly ? import_react95.default.createElement(Spinner2, {
    onClick: handleClickChild,
  ...
  const resizer = multiline && isAfterInitial ? import_react95.default.createElement(Resizer, {
  ...
  const input = (0, import_react95.createElement)(multiline ? "textarea" : "input", {
    name,
    id,
    disabled,
    readOnly,
  ...
  const inputWithVerticalContentMarkup = verticalContent ? import_react95.default.createElement("div", {
  ...
  const backdropMarkup = import_react95.default.createElement("div", {
  ...
  return import_react95.default.createElement(Labelled, {
    label,
    id,
    error,
    action: labelAction,
    ...
    helpText,
    requiredIndicator
  }, import_react95.default.createElement(Connected, {
    left: connectedLeft,
...
function TextField2({
  ...
  const textFieldId = (0, import_react96.useMemo)(() => idProp || uniqueId, [uniqueId, idProp]);
  const labelId = (0, import_react96.useMemo)(() => labelID(idProp || uniqueId), [uniqueId, idProp]);
  (0, import_react96.useEffect)(() => {
    if (setTextFieldLabelId)
      setTextFieldLabelId(labelId);
  }, [labelId, setTextFieldLabelId]);
  const handleFocus = (0, import_react96.useCallback)((event) => {
    if (onFocus)
      onFocus(event);
    if (onTextFieldFocus)
      onTextFieldFocus();
  ...
  const handleBlur = (0, import_react96.useCallback)((event) => {
    if (onBlur)
      onBlur(event);
    if (onTextFieldBlur)
      onTextFieldBlur();
  ...
  const handleChange = (0, import_react96.useCallback)((value2, id) => {
    if (onChange)
      onChange(value2, id);
    if (onTextFieldChange)
      onTextFieldChange(value2);
  }, [onChange, onTextFieldChange]);
  return import_react96.default.createElement(TextField, Object.assign({}, rest, {
    value,
    id: textFieldId,
    type,
    ariaAutocomplete,
...
function Combobox({
  ...
  const [popoverActive, setPopoverActive] = (0, import_react97.useState)(false);
  const [activeOptionId, setActiveOptionId] = (0, import_react97.useState)();
  const [textFieldLabelId, setTextFieldLabelId] = (0, import_react97.useState)();
  const [listboxId, setListboxId] = (0, import_react97.useState)();
  const [textFieldFocused, setTextFieldFocused] = (0, import_react97.useState)(false);
  const [disableCloseOnSelect, setDisableCloseOnSelect] = (0, import_react97.useState)(false);
  const shouldOpen = Boolean(!popoverActive && import_react97.Children.count(children2) > 0);
  ...
  const onOptionSelected = (0, import_react97.useCallback)(() => {
    var _ref$current;
    if (!allowMultiple) {
      handleClose();
      setActiveOptionId(void 0);
  ...
  const handleChange = (0, import_react97.useCallback)(() => {
    if (shouldOpen) {
      handleOpen();
    }
  }, [shouldOpen, handleOpen]);
  const handleBlur = (0, import_react97.useCallback)(() => {
    setDisableCloseOnSelect(false);
    if (popoverActive) {
      handleClose();
    }
  }, [popoverActive, handleClose, setDisableCloseOnSelect]);
  const textFieldContextValue = (0, import_react97.useMemo)(() => ({
    activeOptionId,
  ...
  const listboxOptionContextValue = (0, import_react97.useMemo)(() => ({
    allowMultiple
  }), [allowMultiple]);
  const listboxContextValue = (0, import_react97.useMemo)(() => ({
    listboxId,
    textFieldLabelId,
    textFieldFocused,
    willLoadMoreOptions,
  ...
  return import_react97.default.createElement(Popover2, {
    ref,
    active: popoverActive,
    activator: import_react97.default.createElement(ComboboxTextFieldContext.Provider, {
    ...
    preferredPosition,
    onClose: handleClose
  }, import_react97.Children.count(children2) > 0 ? import_react97.default.createElement(Popover2.Pane, {
    onScrolledToBottom,
    height
  }, import_react97.default.createElement(ComboboxListboxContext.Provider, {
    value: listboxContextValue
  }, import_react97.default.createElement(ComboboxListboxOptionContext.Provider, {
...
function MappedAction({
  ...
  if (prefix) {
    prefixMarkup = import_react98.default.createElement("div", {
      className: styles42.Prefix
    }, prefix);
  } else if (icon) {
    prefixMarkup = import_react98.default.createElement("div", {
      className: styles42.Prefix
    }, import_react98.default.createElement(Icon, {
      source: icon
    }));
  } else if (image) {
    prefixMarkup = import_react98.default.createElement("div", {
  ...
  const badgeMarkup = badge && import_react98.default.createElement("span", {
    className: styles42.Suffix
  }, import_react98.default.createElement(Badge, {
    status: badge.status
  }, badge.content));
  const suffixMarkup = suffix && import_react98.default.createElement("span", {
    className: styles42.Suffix
  }, suffix);
  const contentText = ellipsis && content ? i18n.translate("Polaris.Autocomplete.ellipsis", {
    content
  }) : content;
  const contentMarkup = import_react98.default.createElement("div", {
    className: styles42.Text
  }, import_react98.default.createElement("div", {
    className: contentOverflowStyle
  }, contentText), helpText ? import_react98.default.createElement(TextStyle, {
    variation: "subdued"
  }, helpText) : null);
  ...
  return import_react98.default.createElement(MappedActionContext.Provider, {
    value: context
  }, import_react98.default.createElement("div", {
    className: styles42.ActionContainer
  }, import_react98.default.createElement(Listbox.Action, {
    selected: active,
    disabled,
    value: content || ""
  }, import_react98.default.createElement("div", {
...
var Autocomplete = function Autocomplete2({
  ...
  const i18n = useI18n();
  const buildMappedOptionFromOption = (0, import_react99.useCallback)((options2) => {
    return options2.map((option) => import_react99.default.createElement(MappedOption, Object.assign({
  ...
  const optionsMarkup = (0, import_react99.useMemo)(() => {
    ...
    if (isSection(conditionalOptions)) {
      ...
      const optionsMarkup2 = conditionalOptions.map(({
        ...
        return import_react99.default.createElement(Listbox.Section, {
          divider: false,
          title: import_react99.default.createElement(Listbox.Header, null, title),
          key: title
        }, optionMarkup);
      });
    ...
    if (listTitle) {
      return import_react99.default.createElement(Listbox.Section, {
        divider: false,
        title: import_react99.default.createElement(Listbox.Header, null, listTitle)
      }, optionList);
    }
    return optionList;
  }, [listTitle, loading, options, willLoadMoreResults, buildMappedOptionFromOption]);
  const loadingMarkup = loading ? import_react99.default.createElement(Listbox.Loading, {
    accessibilityLabel: i18n.translate("Polaris.Autocomplete.spinnerAccessibilityLabel")
  }) : null;
  const updateSelection = (0, import_react99.useCallback)((newSelection) => {
    if (allowMultiple) {
  ...
  const actionMarkup = actionBefore && import_react99.default.createElement(MappedAction, actionBefore);
  const emptyStateMarkup = emptyState && options.length < 1 && !loading && import_react99.default.createElement("div", {
    role: "status"
  }, emptyState);
  const autoSelection = actionBefore ? AutoSelection.First : void 0;
  return import_react99.default.createElement(Combobox, {
    activator: textField,
    allowMultiple,
    onScrolledToBottom: onLoadMoreResults,
    preferredPosition,
    willLoadMoreOptions: willLoadMoreResults
  }, actionMarkup || optionsMarkup || loadingMarkup || emptyStateMarkup ? import_react99.default.createElement(Listbox, {
    autoSelection,
...
function useScrollLockManager() {
  const scrollLockManager = (0, import_react100.useContext)(ScrollLockManagerContext);
...
function Backdrop(props) {
  ...
  return import_react102.default.createElement(import_react102.default.Fragment, null, import_react102.default.createElement(ScrollLock, null), import_react102.default.createElement("div", {
    className,
    onClick,
    onTouchStart
  }));
...
var BannerContext = (0, import_react103.createContext)(false);
...
function unstyledButtonFrom({
  ...
  return import_react104.default.createElement(UnstyledButton, Object.assign({
    key,
    onClick: onAction
  }, action, overrides), content);
}
...
// node_modules/@shopify/polaris/build/esm/components/Banner/Banner.js
var Banner = (0, import_react105.forwardRef)(function Banner2({
  icon,
  action,
  secondaryAction,
  title,
  ...
  const withinContentContainer = (0, import_react105.useContext)(WithinContentContext);
  ...
  if (title) {
    ...
    headingMarkup = import_react105.default.createElement("div", {
      className: styles44.Heading,
      id: headingID
    }, import_react105.default.createElement(Heading, {
      element: "p"
    }, title));
  }
  const spinnerMarkup = action !== null && action !== void 0 && action.loading ? import_react105.default.createElement("button", {
    disabled: true,
    "aria-busy": true,
  ...
  }, import_react105.default.createElement(Spinner, {
    size: "small",
    accessibilityLabel: i18n.translate("Polaris.Button.spinnerAccessibilityLabel")
  })), action.content) : null;
  const primaryActionMarkup = action ? import_react105.default.createElement("div", {
    className: styles44.PrimaryAction
  }, action.loading ? spinnerMarkup : unstyledButtonFrom(action, {
    className: styles44.Button
  })) : null;
  const secondaryActionMarkup = secondaryAction ? import_react105.default.createElement(SecondaryActionFrom, {
    action: secondaryAction
  }) : null;
  const actionMarkup = action || secondaryAction ? import_react105.default.createElement("div", {
    className: styles44.Actions
  }, import_react105.default.createElement(ButtonGroup, null, primaryActionMarkup, secondaryActionMarkup)) : null;
  let contentMarkup = null;
  let contentID;
  if (children2 || actionMarkup) {
    contentID = `${id}Content`;
    contentMarkup = import_react105.default.createElement("div", {
      className: styles44.Content,
      id: contentID
    }, children2, actionMarkup);
  }
  const dismissButton = onDismiss && import_react105.default.createElement("div", {
  ...
  return import_react105.default.createElement(BannerContext.Provider, {
    value: true
  ...
  }, dismissButton, import_react105.default.createElement("div", {
    className: styles44.Ribbon
  }, import_react105.default.createElement(Icon, {
    source: iconName,
    color: iconColor
  })), import_react105.default.createElement("div", {
...
function SecondaryActionFrom({
  ...
  if (action.url) {
    return import_react105.default.createElement(UnstyledLink, {
  ...
  return import_react105.default.createElement(UnstyledButton, {
    className: styles44.SecondaryAction,
...
function useBannerFocus(bannerRef) {
  const wrapperRef = (0, import_react105.useRef)(null);
  const [shouldShowFocus, setShouldShowFocus] = (0, import_react105.useState)(false);
  (0, import_react105.useImperativeHandle)(bannerRef, () => ({
    focus: () => {
...
function Breadcrumbs({
  ...
  const contentMarkup = import_react106.default.createElement(import_react106.default.Fragment, null, import_react106.default.createElement("span", {
    className: styles45.Icon
  }, import_react106.default.createElement(Icon, {
    source: SvgArrowLeftMinor
  })), import_react106.default.createElement(VisuallyHidden, null, content));
  const breadcrumbMarkup = "url" in breadcrumb ? import_react106.default.createElement(UnstyledLink, {
    key: content,
    url: breadcrumb.url,
    className: styles45.Breadcrumb,
    onMouseUp: handleMouseUpByBlurring,
    "aria-label": breadcrumb.accessibilityLabel
  }, contentMarkup) : import_react106.default.createElement("button", {
    key: content,
    className: styles45.Breadcrumb,
  ...
  return import_react106.default.createElement("nav", {
    role: "navigation"
  }, breadcrumbMarkup);
}
...
var TransitionGroupContext_default = import_react107.default.createContext(null);
...
var Transition = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return import_react108.default.createElement(TransitionGroupContext_default.Provider, {
      value: null
    }, typeof children2 === "function" ? children2(status, childProps) : import_react108.default.cloneElement(import_react108.default.Children.only(children2), childProps));
  };
  return Transition2;
}(import_react108.default.Component);
...
var CSSTransition = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return import_react109.default.createElement(Transition_default, _extends({}, props, {
...
function getChildMapping(children2, mapFn) {
  var mapper = function mapper2(child) {
    return mapFn && (0, import_react110.isValidElement)(child) ? mapFn(child) : child;
  };
  var result = /* @__PURE__ */ Object.create(null);
  if (children2)
    import_react110.Children.map(children2, function(c) {
      return c;
...
function getNextChildMapping(nextProps, prevChildMapping, onExited) {
  ...
  Object.keys(children2).forEach(function(key) {
    ...
    var isLeaving = (0, import_react110.isValidElement)(prevChild) && !prevChild.props.in;
    if (hasNext && (!hasPrev || isLeaving)) {
      children2[key] = (0, import_react110.cloneElement)(child, {
        onExited: onExited.bind(null, child),
        in: true,
    ...
    } else if (hasNext && hasPrev && (0, import_react110.isValidElement)(prevChild)) {
      children2[key] = (0, import_react110.cloneElement)(child, {
        onExited: onExited.bind(null, child),
...
var TransitionGroup = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return import_react111.default.createElement(TransitionGroupContext_default.Provider, {
      value: contextValue
    }, import_react111.default.createElement(Component9, props, children2));
  };
...
var ReplaceTransition = function(_React$Component) {
  ...
  _proto.handleLifecycle = function handleLifecycle(handler, idx, originalArgs) {
    ...
    var child = import_react112.default.Children.toArray(children2)[idx];
  ...
  _proto.render = function render() {
    ...
    var _React$Children$toArr = import_react112.default.Children.toArray(children2), first = _React$Children$toArr[0], second = _React$Children$toArr[1];
    ...
    return import_react112.default.createElement(TransitionGroup_default, props, inProp ? import_react112.default.cloneElement(first, {
      key: "first",
      onEnter: this.handleEnter,
      onEntering: this.handleEntering,
      onEntered: this.handleEntered
    }) : import_react112.default.cloneElement(second, {
      key: "second",
...
ReplaceTransition.propTypes = true ? {
  ...
  children: function children(props, propName) {
    if (import_react112.default.Children.count(props[propName]) !== 2)
...
function areChildrenDifferent(oldChildren, newChildren) {
  if (oldChildren === newChildren)
    return false;
  if (import_react113.default.isValidElement(oldChildren) && import_react113.default.isValidElement(newChildren) && oldChildren.key != null && oldChildren.key === newChildren.key) {
    return false;
  }
  return true;
}
...
var leaveRenders = (_leaveRenders = {}, _leaveRenders[modes.out] = function(_ref) {
  ...
  return import_react113.default.cloneElement(current, {
    in: false,
  ...
  return [current, import_react113.default.cloneElement(children2, {
    in: true,
...
var enterRenders = (_enterRenders = {}, _enterRenders[modes.out] = function(_ref3) {
  ...
  return import_react113.default.cloneElement(children2, {
    in: true,
    onEntered: callHook(children2, "onEntered", function() {
      changeState(ENTERED, import_react113.default.cloneElement(children2, {
        in: true
      }));
    })
  });
  ...
  }), import_react113.default.cloneElement(children2, {
    in: true
  })];
}, _enterRenders);
var SwitchTransition = function(_React$Component) {
  ...
  SwitchTransition2.getDerivedStateFromProps = function getDerivedStateFromProps(props, state) {
    ...
    return {
      current: import_react113.default.cloneElement(props.children, {
        in: true
      })
    };
  };
  _proto.render = function render() {
    ...
    return import_react113.default.createElement(TransitionGroupContext_default.Provider, {
      value: {
...
function useComponentDidMount(callback) {
  const isAfterInitialMount = useIsAfterInitialMount();
  const hasInvokedLifeCycle = (0, import_react114.useRef)(false);
...
function BulkActionButton({
  ...
  const bulkActionButton = (0, import_react116.useRef)(null);
  ...
  return import_react116.default.createElement("div", {
    ...
    disabled,
    disclosure
  }, content), indicator && import_react116.default.createElement(Indicator, null));
}
...
function BulkActionMenu({
  ...
  return import_react117.default.createElement(import_react117.default.Fragment, null, import_react117.default.createElement(Popover2, {
    active: isVisible,
    activator: import_react117.default.createElement(BulkActionButton, {
      disclosure: true,
    ...
    preferInputActivator: true
  }, import_react117.default.createElement(ActionList, {
    items: actions,
...
var ResourceListContext = (0, import_react118.createContext)({});
...
function CheckableButton({
  ...
  const checkBoxRef = (0, import_react119.useRef)(null);
  const {
    registerCheckableButtons
  } = (0, import_react119.useContext)(ResourceListContext);
  ...
  }, import_react119.default.createElement(Checkbox, {
    label: accessibilityLabel,
    labelHidden: true,
    checked: selected,
    disabled,
...
var BulkActionsInner = class extends import_react120.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
    ...
    this.checkableWrapperNode = (0, import_react120.createRef)();
    this.largeScreenGroupNode = (0, import_react120.createRef)();
    this.smallScreenGroupNode = (0, import_react120.createRef)();
  ...
  render() {
    ...
    const paginatedSelectAllActionMarkup = paginatedSelectAllAction ? import_react120.default.createElement(Button, {
      onClick: paginatedSelectAllAction.onAction,
      plain: true,
      disabled
    }, paginatedSelectAllAction.content) : null;
    const paginatedSelectAllTextMarkup = paginatedSelectAllText && paginatedSelectAllAction ? import_react120.default.createElement("span", {
      "aria-live": "polite"
    }, paginatedSelectAllText) : paginatedSelectAllText;
    const paginatedSelectAllMarkup = paginatedSelectAllActionMarkup || paginatedSelectAllTextMarkup ? import_react120.default.createElement("div", {
      className: styles46.PaginatedSelectAll
    }, paginatedSelectAllTextMarkup, " ", paginatedSelectAllActionMarkup) : null;
    const cancelButton = import_react120.default.createElement(Button, {
      onClick: this.setSelectMode.bind(this, false),
      disabled
    }, i18n.translate("Polaris.Common.cancel"));
    const numberOfPromotedActionsToRender = this.numberOfPromotedActionsToRender();
    const allActionsPopover = this.hasActions() ? import_react120.default.createElement("div", {
      className: styles46.Popover,
      ref: this.setMoreActionsNode
    }, import_react120.default.createElement(Popover2, {
    ...
    const promotedActionsMarkup = promotedActions && numberOfPromotedActionsToRender > 0 ? [...promotedActions].slice(0, numberOfPromotedActionsToRender).map((action, index) => {
      if (instanceOfMenuGroupDescriptor(action)) {
        return import_react120.default.createElement(BulkActionMenu, Object.assign({
          key: index
        }, action, {
          isNewBadgeInBadgeActions: this.isNewBadgeInBadgeActions()
        }));
      }
      return import_react120.default.createElement(BulkActionButton, Object.assign({
        key: index,
        disabled
      }, action, {
    ...
    const actionsPopover = actionSections || rolledInPromotedActions.length > 0 || measuring ? import_react120.default.createElement("div", {
      className: styles46.Popover,
      ref: this.setMoreActionsNode
    }, import_react120.default.createElement(Popover2, {
    ...
    const smallScreenGroup = smallScreen ? import_react120.default.createElement(Transition_default, {
      timeout: 0,
      in: selectMode,
      key: "smallGroup",
      ...
      }, import_react120.default.createElement(ButtonGroup, {
        segmented: true
      }, import_react120.default.createElement(CSSTransition_default, {
      ...
      }, import_react120.default.createElement(CheckableButton, Object.assign({}, checkableButtonProps, {
        smallScreen: true
      })))), allActionsPopover, cancelButton)), paginatedSelectAllMarkup);
    }) : null;
    const largeGroupContent = promotedActionsMarkup || actionsPopover ? import_react120.default.createElement(ButtonGroup, {
      segmented: true
    }, import_react120.default.createElement(CheckableButton, checkableButtonProps), promotedActionsMarkup, actionsPopover) : import_react120.default.createElement(CheckableButton, checkableButtonProps);
    const largeScreenGroup = smallScreen ? null : import_react120.default.createElement(Transition_default, {
      timeout: 0,
      in: selectMode,
      key: "largeGroup",
      ...
      }, import_react120.default.createElement(EventListener, {
        event: "resize",
...
function BulkActions(props) {
  const i18n = useI18n();
  return import_react120.default.createElement(BulkActionsInner, Object.assign({}, props, {
    i18n
  }));
}
...
function CalloutCard({
  ...
  const buttonMarkup = secondaryActionMarkup ? import_react122.default.createElement(ButtonGroup, null, primaryActionMarkup, secondaryActionMarkup) : primaryActionMarkup;
  const dismissButton = onDismiss ? import_react122.default.createElement("div", {
  ...
  return import_react122.default.createElement(Card, null, import_react122.default.createElement("div", {
    className: containerClassName
  }, dismissButton, import_react122.default.createElement(Card.Section, null, import_react122.default.createElement("div", {
  ...
  }, import_react122.default.createElement(Heading, null, title)), import_react122.default.createElement(TextContainer, null, children2), import_react122.default.createElement("div", {
    className: styles49.Buttons
  }, buttonMarkup)), import_react122.default.createElement(Image, {
    alt: "",
    className: imageClassName,
    source: illustration
  })))));
...
function Caption({
  ...
  return import_react123.default.createElement("p", {
...
function RadioButton({
  ...
  const inputNode = (0, import_react124.useRef)(null);
  const [keyFocused, setKeyFocused] = (0, import_react124.useState)(false);
  const {
    value: mouseOver,
    setTrue: handleMouseOver,
    setFalse: handleMouseOut
  ...
  return import_react124.default.createElement(Choice, {
    label,
    labelHidden,
    disabled,
    id,
  ...
  }, import_react124.default.createElement("input", {
    id,
    name,
    value,
    type: "radio",
...
function ChoiceList({
  ...
  const titleMarkup = title ? import_react125.default.createElement("legend", {
  ...
  const choicesMarkup = choices.map((choice) => {
    ...
    const children2 = renderedChildren ? import_react125.default.createElement("div", {
      className: styles52.ChoiceChildren
    }, renderedChildren) : null;
    return import_react125.default.createElement("li", {
      key: value,
      className: styles52.ChoiceItem
    }, import_react125.default.createElement(ControlComponent, {
      name: finalName,
      value,
      label,
  ...
  const errorMarkup = error && import_react125.default.createElement("div", {
    className: styles52.ChoiceError
  }, import_react125.default.createElement(InlineError, {
    message: error,
    fieldID: finalName
  }));
  return import_react125.default.createElement("fieldset", {
    className,
    id: finalName,
    "aria-invalid": error != null
  }, titleMarkup, import_react125.default.createElement("ul", {
...
function Collapsible({
  ...
  const [height, setHeight] = (0, import_react126.useState)(0);
  const [isOpen, setIsOpen] = (0, import_react126.useState)(open);
  const [animationState, setAnimationState] = (0, import_react126.useState)("idle");
  const collapsibleContainer = (0, import_react126.useRef)(null);
  ...
  const handleCompleteAnimation = (0, import_react126.useCallback)(({
    target
  }) => {
...
var Slidable = class extends import_react127.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      dragging: false
  ...
  render() {
    ...
    const moveListener = dragging ? import_react127.default.createElement(EventListener, {
      event: "mousemove",
      handler: this.handleMove,
      passive: false
    }) : null;
    const touchMoveListener = dragging ? import_react127.default.createElement(EventListener, {
      event: "touchmove",
      handler: this.handleMove,
      passive: false
    }) : null;
    const endDragListener = dragging ? import_react127.default.createElement(EventListener, {
      event: "mouseup",
      handler: this.handleDragEnd
    }) : null;
    const touchEndListener = dragging ? import_react127.default.createElement(EventListener, {
      event: "touchend",
      handler: this.handleDragEnd
    }) : null;
    const touchCancelListener = dragging ? import_react127.default.createElement(EventListener, {
      event: "touchcancel",
      handler: this.handleDragEnd
    }) : null;
    ...
    }, endDragListener, moveListener, touchMoveListener, touchEndListener, touchCancelListener, import_react127.default.createElement("div", {
...
// node_modules/@shopify/polaris/build/esm/components/ColorPicker/components/AlphaPicker/AlphaPicker.js
var AlphaPicker = class extends import_react128.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      sliderHeight: 0,
  ...
  render() {
    ...
    }), import_react128.default.createElement(Slidable, {
      draggerY,
      draggerX: 0,
...
// node_modules/@shopify/polaris/build/esm/components/ColorPicker/components/HuePicker/HuePicker.js
var HuePicker = class extends import_react129.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      sliderHeight: 0,
  ...
  render() {
    ...
    return import_react129.default.createElement("div", {
      ...
      ref: this.setSliderHeight
    }, import_react129.default.createElement(Slidable, {
      draggerY,
      draggerX: 0,
      onChange: this.handleChange,
      onDraggerHeight: this.setDraggerHeight
...
var ColorPicker = class extends import_react130.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      pickerSize: {
  ...
  render() {
    ...
    const alphaSliderMarkup = allowAlpha ? import_react130.default.createElement(AlphaPicker, {
      alpha,
      color,
    ...
    }), import_react130.default.createElement(Slidable, {
      onChange: this.handleDraggerMove,
      draggerX,
      draggerY
    })), import_react130.default.createElement(HuePicker, {
      hue,
      onChange: this.handleHueChange
    }), alphaSliderMarkup, import_react130.default.createElement(EventListener, {
      event: "resize",
      handler: this.handleResize
    }));
  }
...
var FrameContext = (0, import_react131.createContext)(void 0);

// node_modules/@shopify/polaris/build/esm/utilities/frame/hooks.js
function useFrame() {
  const frame = (0, import_react132.useContext)(FrameContext);
  if (!frame) {
...
// node_modules/@shopify/polaris/build/esm/components/ContextualSaveBar/ContextualSaveBar.js
var ContextualSaveBar = (0, import_react133.memo)(function ContextualSaveBar2({
  message,
  saveAction,
  discardAction,
  alignContentFlush,
...
function TooltipOverlay({
  ...
  const i18n = useI18n();
  const markup = active ? import_react134.default.createElement(PositionedOverlay, {
    active,
    activator,
    preferredPosition,
    preventInteraction,
  ...
  function renderTooltip(overlayDetails) {
    ...
    return import_react134.default.createElement("div", Object.assign({
      className: containerClassName
    }, layer.props), import_react134.default.createElement("div", {
      id,
      role: "tooltip",
...
function Tooltip({
  ...
  const [activatorNode, setActivatorNode] = (0, import_react135.useState)(null);
  const id = useUniqueId("TooltipContent");
  const activatorContainer = (0, import_react135.useRef)(null);
  const mouseEntered = (0, import_react135.useRef)(false);
  ...
  const handleKeyUp = (0, import_react135.useCallback)((event) => {
    if (event.keyCode !== Key.Escape)
      return;
    handleBlur();
  }, [handleBlur]);
  const portal2 = activatorNode ? import_react135.default.createElement(Portal, {
    idPrefix: "tooltip"
  }, import_react135.default.createElement(TooltipOverlay, {
    id,
    preferredPosition,
    activator: activatorNode,
    active,
  ...
  return import_react135.default.createElement(WrapperComponent, {
    onFocus: handleFocus,
    onBlur: handleBlur,
...
function Cell({
  ...
  const [showTooltip, setShowTooltip] = (0, import_react136.useState)(false);
  ...
  const iconMarkup = import_react136.default.createElement("span", {
    className: iconClassName
  }, import_react136.default.createElement(Icon, {
    source,
    accessibilityLabel: sortAccessibilityLabel
  }));
  const focusable = inFixedFirstColumn || !(hasFixedFirstColumn && firstColumn);
  const sortableHeadingContent = import_react136.default.createElement("button", {
  ...
  const stickyHeading = import_react136.default.createElement("th", Object.assign({
    ref: setRef
  ...
  const headingMarkup = header ? import_react136.default.createElement("th", Object.assign({}, headerCell.props, colSpanProp, {
    ref: setRef,
    className,
    scope: "col",
    "aria-sort": sortDirection,
  ...
  }), columnHeadingContent) : import_react136.default.createElement("th", Object.assign({
    style: {
      minWidth: firstColumnMinWidth
    },
    className,
  ...
  }), showTooltip ? import_react136.default.createElement(Tooltip, {
    content
  }, import_react136.default.createElement("span", {
    className: styles56.TooltipContent
  }, content)) : content);
  const cellMarkup = header || firstColumn ? headingMarkup : import_react136.default.createElement("td", Object.assign({
    className
  }, colSpanProp), content);
...
function Navigation({
  ...
  }, import_react137.default.createElement(Button, {
    plain: true,
    icon: SvgChevronLeftMinor,
    disabled: isScrolledFarthestLeft,
    accessibilityLabel: leftA11yLabel,
    onClick: navigateTableLeft
  }), pipMarkup, import_react137.default.createElement(Button, {
    plain: true,
...
// node_modules/@shopify/polaris/build/esm/components/DataTable/DataTable.js
var DataTableInner = class extends import_react141.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      condensed: false,
    ...
    this.dataTable = (0, import_react141.createRef)();
    this.scrollContainer = (0, import_react141.createRef)();
    this.table = (0, import_react141.createRef)();
    this.stickyTableHeadingsRow = (0, import_react141.createRef)();
    this.tableHeadings = [];
    this.stickyHeadings = [];
    ...
    this.handleHeaderButtonFocus = (event) => {
      ...
      const firstColumnWidth = this.state.columnVisibilityData.length > 0 ? this.state.columnVisibilityData[0].rightEdge : 0;
    ...
    this.handleFocus = (event) => {
      ...
      const firstColumnWidth = hasFixedFirstColumn ? this.state.columnVisibilityData[0].rightEdge : 0;
      const currentColumnLeftEdge = currentCell.offsetLeft;
    ...
    this.renderHeading = ({
      ...
      return import_react141.default.createElement(Cell, Object.assign({
        setRef: (ref) => {
          this.setCellRef({
            ref,
            index: headingIndex,
    ...
    this.renderTotals = (total, index) => {
      ...
      return import_react141.default.createElement(Cell, {
        total: true,
        totalInFooter,
        firstColumn: index === 0,
        key: id,
    ...
    this.defaultRenderRow = ({
      ...
      return import_react141.default.createElement("tr", {
        key: `row-${index}`,
        className,
  ...
  render() {
    ...
    const headingMarkup = import_react141.default.createElement("tr", null, headings.map((heading, index) => this.renderHeading({
      heading,
      headingIndex: index,
      inFixedFirstColumn: false,
      inStickyHeader: false
    })));
    const totalsMarkup = totals ? import_react141.default.createElement("tr", null, totals.map(this.renderTotals)) : null;
    ...
    const fixedFirstColumn = condensed && hasFixedFirstColumn && import_react141.default.createElement("table", {
    ...
    }, import_react141.default.createElement("thead", null, import_react141.default.createElement("tr", null, firstHeading.map((heading, index) => this.renderHeading({
      heading,
      headingIndex: index,
      inFixedFirstColumn: true,
      inStickyHeader: false
    }))), totals && !showTotalsInFooter && import_react141.default.createElement("tr", null, firstTotal === null || firstTotal === void 0 ? void 0 : firstTotal.map(this.renderTotals))), import_react141.default.createElement("tbody", null, firstColumn.map((row, index) => this.defaultRenderRow({
      row,
      index,
      inFixedFirstColumn: true
    }))), totals && showTotalsInFooter && import_react141.default.createElement("tfoot", null, import_react141.default.createElement("tr", null, firstTotal === null || firstTotal === void 0 ? void 0 : firstTotal.map(this.renderTotals))));
    const bodyMarkup = rows.map((row, index) => this.defaultRenderRow({
      row,
      index,
      inFixedFirstColumn: false
    }));
    const footerMarkup = footerContent ? import_react141.default.createElement("div", {
      className: styles56.Footer
    }, footerContent) : null;
    const headerTotalsMarkup = !showTotalsInFooter ? totalsMarkup : null;
    const footerTotalsMarkup = showTotalsInFooter ? import_react141.default.createElement("tfoot", null, totalsMarkup) : null;
    const navigationMarkup = hideScrollIndicator ? null : import_react141.default.createElement(Navigation, {
      columnVisibilityData,
      isScrolledFarthestLeft,
      isScrolledFarthestRight,
    ...
    const stickyHeaderMarkup = stickyHeader ? import_react141.default.createElement(AfterInitialMount, null, import_react141.default.createElement("div", {
      className: styles56.StickyTable,
      role: "presentation"
    }, import_react141.default.createElement(Sticky, {
      ...
      const fixedFirstStickyHeading = hasFixedFirstColumn ? import_react141.default.createElement("table", {
        className: classNames(!isScrolledFarthestLeft && styles56.separate, styles56.FixedFirstColumn)
      }, import_react141.default.createElement("thead", null, import_react141.default.createElement("tr", null, this.renderHeading({
        heading: headings[0],
        headingIndex: 0,
        inFixedFirstColumn: true,
        inStickyHeader: true
      })))) : null;
      return import_react141.default.createElement("table", {
        className: stickyHeaderClassNames
      }, import_react141.default.createElement("div", null, navigationMarkup), import_react141.default.createElement("tr", {
    ...
    return import_react141.default.createElement("div", {
      className: wrapperClassName
    }, navigationMarkup, import_react141.default.createElement("div", {
      className,
      ref: this.dataTable
    }, stickyHeaderMarkup, import_react141.default.createElement("div", {
      className: styles56.ScrollContainer,
      ref: this.scrollContainer
    }, import_react141.default.createElement(EventListener, {
      event: "resize",
      handler: this.handleResize
    }), import_react141.default.createElement(EventListener, {
      capture: true,
    ...
    }), fixedFirstColumn, import_react141.default.createElement("table", {
      className: styles56.Table,
      ref: this.table
    }, import_react141.default.createElement("thead", null, headingMarkup, headerTotalsMarkup), import_react141.default.createElement("tbody", null, bodyMarkup), footerTotalsMarkup)), footerMarkup));
  }
};
function DataTable(props) {
  const i18n = useI18n();
  return import_react141.default.createElement(DataTableInner, Object.assign({}, props, {
    i18n
  }));
}
...
var Weekday = (0, import_react142.memo)(function Weekday2({
  label,
  title,
  current
}) {
  const className = classNames(styles58.Weekday, current && styles58["Weekday-current"]);
  return import_react142.default.createElement("th", {
    "aria-label": label,
    scope: "col",
    className
  }, title);
...
var Day = (0, import_react143.memo)(function Day2({
  day,
  focused,
  onClick,
  onHover = noop7,
  ...
  const i18n = useI18n();
  const dayNode = (0, import_react143.useRef)(null);
  ...
  if (!day) {
    return import_react143.default.createElement("td", {
  ...
  }, import_react143.default.createElement("button", {
    onFocus: () => onFocus(day),
    type: "button",
    ref: dayNode,
    tabIndex,
...
function Month({
  ...
  const weeks = (0, import_react144.useMemo)(() => getWeeksForMonth(month, year, weekStartsOn), [month, weekStartsOn, year]);
  const weekdays = getOrderedWeekdays(weekStartsOn).map((weekday) => import_react144.default.createElement(Weekday, {
    key: weekday,
    title: i18n.translate(`Polaris.DatePicker.daysAbbreviated.${weekdayName(weekday)}`),
    label: weekdayLabel(weekday),
    current: current && new Date().getDay() === weekday
  }));
  const handleDateClick = (0, import_react144.useCallback)((selectedDate) => {
    onChange(getNewRange(allowRange ? selected : void 0, selectedDate));
  }, [allowRange, onChange, selected]);
  const lastDayOfMonth = (0, import_react144.useMemo)(() => new Date(year, month + 1, 0), [month, year]);
  function renderWeek(day, dayIndex) {
    if (day == null) {
      return import_react144.default.createElement(Day, {
        key: dayIndex,
        onHover,
        lastDayOfMonth
      });
  ...
  const weeksMarkup = weeks.map((week, index) => import_react144.default.createElement("tr", {
    className: styles58.Week,
    key: index
  }, week.map(renderWeek)));
  return import_react144.default.createElement("div", {
    className: styles58.MonthContainer
  }, import_react144.default.createElement("table", {
    role: "grid",
    className: styles58.Month
  }, import_react144.default.createElement("caption", {
    className
  }, i18n.translate(`Polaris.DatePicker.months.${monthName(month)}`), " ", year), import_react144.default.createElement("thead", null, import_react144.default.createElement("tr", {
    className: styles58.WeekHeadings
  }, weekdays)), import_react144.default.createElement("tbody", null, weeksMarkup)));
...
function DatePicker({
  ...
  const i18n = useI18n();
  const [hoverDate, setHoverDate] = (0, import_react145.useState)(void 0);
  const [focusDate, setFocusDate] = (0, import_react145.useState)(void 0);
  (0, import_react145.useEffect)(() => {
    setFocusDate(void 0);
  }, [selected]);
  const handleFocus = (0, import_react145.useCallback)((date) => {
    setFocusDate(date);
  }, []);
  const setFocusDateAndHandleMonthChange = (0, import_react145.useCallback)((date) => {
    if (onMonthChange) {
  ...
  const handleDateSelection = (0, import_react145.useCallback)((range) => {
    const {
      end
    } = range;
    setHoverDate(end);
  ...
  const handleMonthChangeClick = (0, import_react145.useCallback)((month2, year2) => {
    if (!onMonthChange) {
      return;
    }
    setFocusDate(void 0);
  ...
  const handleHover = (0, import_react145.useCallback)((date) => {
    setHoverDate(date);
  }, []);
  ...
  const monthIsSelected = (0, import_react145.useMemo)(() => deriveRange(selected), [selected]);
  ...
  const secondDatePicker = multiMonth ? import_react145.default.createElement(Month, {
    onFocus: handleFocus,
  ...
  }, import_react145.default.createElement(Month, {
    onFocus: handleFocus,
    focusedDate: focusDate,
    month,
    year,
...
function DescriptionList({
  ...
  const terms = items.reduce((allTerms, {
    term,
    description
  }, index) => [...allTerms, import_react146.default.createElement("dt", {
    key: `dt${index}`,
    className: styles59.Term
  }, term), import_react146.default.createElement("dd", {
    key: `dd${index}`,
    className: styles59.Description
  }, description)], []);
  const className = classNames(styles59.DescriptionList, spacing2 === "tight" && styles59.spacingTight);
  return import_react146.default.createElement("dl", {
    className
  }, terms);
}
...
// node_modules/@shopify/polaris/build/esm/components/DropZone/context.js
var DropZoneContext = (0, import_react148.createContext)({
  disabled: false,
  focused: false,
  size: "extraLarge",
  type: "file",
...
function FileUpload(props) {
  ...
  const {
    ...
    disabled,
    allowMultiple
  } = (0, import_react149.useContext)(DropZoneContext);
  ...
  const actionMarkup = import_react149.default.createElement("div", {
    className: actionClassNames
  }, actionTitle);
  ...
  const actionHintMarkup = actionHint && import_react149.default.createElement(Caption, null, import_react149.default.createElement(TextStyle, {
    variation: "subdued"
  }, actionHint));
  let viewMarkup;
  switch (size) {
    case "large":
      viewMarkup = import_react149.default.createElement(Stack, {
        vertical: true,
        spacing: "tight"
    ...
    case "medium":
      ...
      break;
    case "small":
      viewMarkup = import_react149.default.createElement("img", {
        width: "20",
        src: uploadArrow,
        alt: ""
      });
...
var DropZone = function DropZone2({
  ...
  const node = (0, import_react150.useRef)(null);
  const dragTargets = (0, import_react150.useRef)([]);
  const adjustSize = (0, import_react150.useCallback)(debounce(() => {
    if (!node.current) {
      return;
    }
    if (variableHeight) {
  ...
  const [dragging, setDragging] = (0, import_react150.useState)(false);
  const [internalError, setInternalError] = (0, import_react150.useState)(false);
  const {
    value: focused,
    setTrue: handleFocus,
    setFalse: handleBlur
  } = useToggle(false);
  const [size, setSize] = (0, import_react150.useState)("large");
  const [measuring, setMeasuring] = (0, import_react150.useState)(true);
  const i18n = useI18n();
  const getValidatedFiles = (0, import_react150.useCallback)((files) => {
    const acceptedFiles = [];
    const rejectedFiles = [];
  ...
  const handleDrop = (0, import_react150.useCallback)((event) => {
    stopEvent(event);
    if (disabled)
      return;
  ...
  const handleDragEnter = (0, import_react150.useCallback)((event) => {
    stopEvent(event);
    if (disabled)
      return;
    const fileList = getDataTransferFiles(event);
  ...
  const handleDragOver = (0, import_react150.useCallback)((event) => {
    stopEvent(event);
    if (disabled)
      return;
    onDragOver && onDragOver();
  }, [disabled, onDragOver]);
  const handleDragLeave = (0, import_react150.useCallback)((event) => {
    event.preventDefault();
    if (disabled)
      return;
  ...
  return import_react150.default.createElement(DropZoneContext.Provider, {
    value: context
  }, import_react150.default.createElement(Labelled, {
    id,
    label: labelValue,
    action: labelAction,
  ...
  }, dragOverlay, dragErrorOverlay, import_react150.default.createElement(VisuallyHidden, null, import_react150.default.createElement(DropZoneInput, Object.assign({}, inputAttributes, {
    openFileDialog,
    onFileDialogClose
  }))), import_react150.default.createElement("div", {
  ...
  function overlayMarkup(icon, color, text) {
    ...
    }, import_react150.default.createElement(Stack, {
      vertical: true,
      spacing: "tight"
    }, size === "small" && import_react150.default.createElement(Icon, {
      source: icon,
      color
    }), (size === "medium" || size === "large") && import_react150.default.createElement(Caption, null, import_react150.default.createElement(TextStyle, {
      variation: "strong"
    }, text))));
  }
  function open() {
...
var DropZoneInput = class extends import_react150.Component {
  constructor(...args) {
    super(...args);
    this.fileInputNode = (0, import_react150.createRef)();
  ...
  render() {
    ...
    return import_react150.default.createElement("input", Object.assign({}, inputProps, {
...
function EmptySearchResult({
  ...
  const descriptionMarkup = description ? import_react151.default.createElement("p", null, description) : null;
  const illustrationMarkup = withIllustration ? import_react151.default.createElement(Image, {
    alt: altText,
    source: emptySearch,
    draggable: false
  }) : null;
  return import_react151.default.createElement(Stack, {
    alignment: "center",
    vertical: true
  }, illustrationMarkup, import_react151.default.createElement(DisplayText, {
    size: "small"
  }, title), import_react151.default.createElement(TextStyle, {
    variation: "subdued"
  }, descriptionMarkup));
}
...
function EmptyState({
  ...
  const withinContentContainer = (0, import_react152.useContext)(WithinContentContext);
  ...
  const imageMarkup = largeImage ? import_react152.default.createElement(Image, {
    alt: "",
    role: "presentation",
  ...
  }) : import_react152.default.createElement(Image, {
    role: "presentation",
    alt: "",
    className: styles63.Image,
    source: image
  ...
  const footerContentMarkup = footerContent ? import_react152.default.createElement("div", {
    className: styles63.FooterContent
  }, import_react152.default.createElement(TextContainer, null, footerContent)) : null;
  const headingSize = withinContentContainer ? "small" : "medium";
  const primaryActionMarkup = action ? buttonFrom(action, {
    primary: true,
    size: "medium"
  }) : null;
  const headingMarkup = heading ? import_react152.default.createElement(DisplayText, {
    size: headingSize
  }, heading) : null;
  const childrenMarkup = children2 ? import_react152.default.createElement("div", {
    className: styles63.Content
  }, children2) : null;
  const textContentMarkup = headingMarkup || children2 ? import_react152.default.createElement(TextContainer, null, headingMarkup, childrenMarkup) : null;
  const actionsMarkup = primaryActionMarkup || secondaryActionMarkup ? import_react152.default.createElement("div", {
  ...
  const detailsMarkup = textContentMarkup || actionsMarkup || footerContentMarkup ? import_react152.default.createElement("div", {
    className: styles63.DetailsContainer
  }, import_react152.default.createElement("div", {
    className: styles63.Details
  }, textContentMarkup, actionsMarkup, footerContentMarkup)) : import_react152.default.createElement("div", {
    className: styles63.DetailsContainer
  });
  ...
  }, detailsMarkup, import_react152.default.createElement("div", {
...
function ExceptionList({
  ...
  const items = itemsList.map((item, index) => {
    ...
    const iconMarkup = icon ? import_react154.default.createElement(Icon, {
      source: icon
    }) : import_react154.default.createElement("span", {
      className: styles64.Bullet
    });
    const titleMarkup = title && import_react154.default.createElement("span", {
      className: styles64.Title
    }, title);
    const descriptionMarkup = description && import_react154.default.createElement("span", {
      className: styles64.Description
    }, description);
    const Element2 = truncate ? Truncate : import_react154.Fragment;
    return import_react154.default.createElement("li", {
      className: itemClasses,
      key: index
    }, import_react154.default.createElement("span", {
      className: styles64.Icon
    }, iconMarkup), import_react154.default.createElement(Element2, null, titleMarkup, descriptionMarkup));
  });
  return import_react154.default.createElement("ul", {
...
var ConnectedFilterControl = class extends import_react156.Component {
  constructor(...args) {
    super(...args);
    this.state = {
      availableWidth: 0,
    ...
    this.container = (0, import_react156.createRef)();
    this.proxyButtonContainer = (0, import_react156.createRef)();
    this.moreFiltersButtonContainer = (0, import_react156.createRef)();
    this.handleResize = debounce(() => {
  ...
  render() {
    ...
    const rightMarkup = actionsToRender.length > 0 ? import_react156.default.createElement("div", {
    ...
    const rightActionMarkup = rightAction ? import_react156.default.createElement("div", {
      ref: this.moreFiltersButtonContainer,
      className: moreFiltersButtonContainerClassname
    }, shouldRenderMoreFiltersButton && import_react156.default.createElement(Item5, null, rightAction)) : null;
    const proxyButtonMarkup = rightPopoverableActions ? import_react156.default.createElement("div", {
      className: styles67.ProxyButtonContainer,
      ref: this.proxyButtonContainer,
      "aria-hidden": true
    }, rightPopoverableActions.map((action) => import_react156.default.createElement("div", {
      key: action.key,
      "data-key": action.key
    }, this.activatorButtonFrom(action, {
      proxy: true
    })))) : null;
    const auxMarkup = auxiliary ? import_react156.default.createElement("div", {
      className: styles67.AuxiliaryContainer
    }, auxiliary) : null;
    return import_react156.default.createElement(import_react156.default.Fragment, null, proxyButtonMarkup, import_react156.default.createElement("div", {
      className: styles67.Wrapper
    }, import_react156.default.createElement("div", {
      className,
      ref: this.container
    }, children2 ? import_react156.default.createElement("div", {
      className: styles67.CenterContainer
    }, import_react156.default.createElement(Item5, null, children2)) : null, rightMarkup, rightActionMarkup, import_react156.default.createElement(EventListener, {
      event: "resize",
      handler: this.handleResize
    })), auxMarkup));
  }
  ...
  activatorButtonFrom(action, options) {
    ...
    return import_react156.default.createElement(Button, {
      onClick: action.onAction,
      disclosure: true,
  ...
  popoverFrom(actions) {
    return actions.map((action) => {
      return import_react156.default.createElement(Item5, {
        key: action.key
      }, import_react156.default.createElement(Popover2, {
...
function TagsWrapper({
  ...
  if (hidden) {
    return import_react157.default.createElement(VisuallyHidden, null, children2);
  }
  return import_react157.default.createElement(import_react157.default.Fragment, null, children2);
}
...
function Tag({
  ...
  const removeButton = onRemove ? import_react158.default.createElement("button", {
    type: "button",
    "aria-label": ariaLabel,
    ...
    onMouseUp: handleMouseUpByBlurring,
    disabled
  }, import_react158.default.createElement(Icon, {
    source: SvgCancelSmallMinor
  })) : null;
  const tagContent = url && !disabled ? import_react158.default.createElement("a", {
    className: classNames(styles68.Link, segmented && styles68.segmented),
    href: url
  }, import_react158.default.createElement("span", {
    title: tagTitle,
    className: styles68.LinkText
  }, children2)) : import_react158.default.createElement("span", {
    title: tagTitle,
    className: styles68.TagText
  }, children2);
  return import_react158.default.createElement("span", {
    className
...
function useMediaQuery() {
  const mediaQuery = (0, import_react159.useContext)(MediaQueryContext);
  if (!mediaQuery) {
...
function useFocusManager({
  ...
  const focusManager = (0, import_react160.useContext)(FocusManagerContext);
  ...
  const value = (0, import_react160.useMemo)(() => ({
    canSafelyFocus
  }), [canSafelyFocus]);
...
var Focus = (0, import_react161.memo)(function Focus2({
  children: children2,
  disabled,
  root
}) {
  ...
  return import_react161.default.createElement(import_react161.default.Fragment, null, children2);
});
function isRef(ref) {
...
function TrapFocus({
  ...
  const focusTrapWrapper = (0, import_react162.useRef)(null);
  const [disableFocus, setDisableFocus] = (0, import_react162.useState)(true);
  ...
  return import_react162.default.createElement(Focus, {
    disabled: disableFocus,
    root: focusTrapWrapper.current
  }, import_react162.default.createElement("div", {
    ref: focusTrapWrapper
  }, import_react162.default.createElement(EventListener, {
    event: "focusin",
    handler: handleFocusIn
  }), import_react162.default.createElement(KeypressListener, {
    keyCode: Key.Tab,
    keyEvent: "keydown",
    handler: handleTab
  }), children2));
...
function Sheet({
  ...
  const container = (0, import_react163.useRef)(null);
  const activatorRef = (0, import_react163.useRef)(null);
  const handleClose = (0, import_react163.useCallback)(() => {
    onClose();
  ...
  const activatorMarkup = activator && !isRef2(activator) ? import_react163.default.createElement("div", {
    ref: activatorRef
  }, activator) : null;
  return import_react163.default.createElement(import_react163.default.Fragment, null, activatorMarkup, import_react163.default.createElement(Portal, {
    idPrefix: "sheet"
  }, import_react163.default.createElement(CSSTransition_default, {
    nodeRef: container,
    ...
    onEntered,
    onExit
  }, import_react163.default.createElement("div", Object.assign({
    className: styles69.Container
  }, layer.props, overlay.props, {
    ref: container
  }), import_react163.default.createElement(TrapFocus, {
    trapping: open
    ...
    "aria-label": accessibilityLabel
  }, children2)))), import_react163.default.createElement(KeypressListener, {
    keyCode: Key.Escape,
    handler: handleClose
  }), open && import_react163.default.createElement(Backdrop, {
    transparent: true,
    onClick: handleClose
  })));
}
...
var FiltersInner = class extends import_react164.Component {
  constructor(...args) {
    super(...args);
    this.state = {
      open: false,
    ...
    this.moreFiltersButtonContainer = (0, import_react164.createRef)();
    this.moreFiltersDoneButtonContainer = (0, import_react164.createRef)();
    this.focusNode = (0, import_react164.createRef)();
    this.closeFilters = () => {
      this.setState({
        open: false
      }, () => {
  ...
  render() {
    ...
    const backdropMarkup = open ? import_react164.default.createElement(import_react164.default.Fragment, null, import_react164.default.createElement(ScrollLock, null), import_react164.default.createElement("div", {
    ...
    const filtersContentMarkup = filters.map((filter, index) => {
      ...
      const appliedFilterBadgeMarkup = appliedFilterContent ? import_react164.default.createElement("div", {
        className: styles66.AppliedFilterBadgeContainer
      }, import_react164.default.createElement(Badge, {
        size: "small",
        status: "new"
      ...
      }, import_react164.default.createElement("h3", {
        className: styles66.FilterTriggerTitle
      }, import_react164.default.createElement(TextStyle, {
        variation: this.props.disabled || filter.disabled ? "subdued" : void 0
      }, filter.label)), import_react164.default.createElement("span", {
        className: styles66.FilterTriggerIcon
      }, import_react164.default.createElement(Icon, {
        source: icon,
        color: "base"
      }))), appliedFilterBadgeMarkup), import_react164.default.createElement(Collapsible, {
        id: collapsibleID,
        open: filterIsOpen
      }, import_react164.default.createElement("div", {
        className: styles66.FilterNodeContainer
      }, import_react164.default.createElement(Focus, {
    ...
    const rightActionMarkup = filters.length ? import_react164.default.createElement("div", {
      ref: this.moreFiltersButtonContainer
    }, import_react164.default.createElement(Button, {
    ...
    const filtersControlMarkup = import_react164.default.createElement(ConnectedFilterControl, {
    ...
    }, hideQueryField ? null : import_react164.default.createElement(TextField, {
      ...
      labelHidden: true,
      prefix: import_react164.default.createElement("span", {
    ...
    const filtersDesktopHeaderMarkup = import_react164.default.createElement("div", {
      className: filtersContainerHeaderClassname
    }, import_react164.default.createElement(DisplayText, {
      size: "small",
      element: "h3"
    }, moreFiltersLabel), import_react164.default.createElement(Button, {
      icon: SvgCancelSmallMinor,
      plain: true,
      accessibilityLabel: i18n.translate("Polaris.Filters.cancel"),
      onClick: this.closeFilters
    }));
    const filtersMobileHeaderMarkup = import_react164.default.createElement("div", {
      className: filtersContainerHeaderClassname
    }, import_react164.default.createElement(Button, {
      icon: SvgCancelSmallMinor,
      plain: true,
    ...
    const filtersDesktopFooterMarkup = import_react164.default.createElement("div", {
      className: filtersDesktopFooterClassname
    }, import_react164.default.createElement(Button, {
      onClick: this.handleClearAll,
      disabled: !this.hasAppliedFilters()
    }, i18n.translate("Polaris.Filters.clearAllFilters")), import_react164.default.createElement("div", {
      ref: this.moreFiltersDoneButtonContainer
    }, import_react164.default.createElement(Button, {
      onClick: this.closeFilters,
      primary: true
    }, i18n.translate("Polaris.Filters.done"))));
    const filtersMobileFooterMarkup = import_react164.default.createElement("div", {
      className: styles66.FiltersMobileContainerFooter
    }, this.hasAppliedFilters() ? import_react164.default.createElement(Button, {
      onClick: onClearAll,
      fullWidth: true
    }, i18n.translate("Polaris.Filters.clearAllFilters")) : import_react164.default.createElement("div", {
      ...
      variation: "subdued"
    }, import_react164.default.createElement("p", null, i18n.translate("Polaris.Filters.noFiltersApplied")))));
    const shouldHideTagsContainer = !appliedFilters || appliedFilters.length < 1;
    const tagsMarkup = !hideTags ? import_react164.default.createElement(TagsWrapper, {
      hidden: shouldHideTagsContainer
    }, import_react164.default.createElement("div", {
      className: styles66.TagsContainer,
      "aria-live": "polite"
    }, (appliedFilters || []).map((filter) => {
      return import_react164.default.createElement(Tag, {
        key: filter.key,
        onRemove: () => {
    ...
    const filtersContainerMarkup = isNavigationCollapsed ? import_react164.default.createElement(Sheet, {
      accessibilityLabel: moreFiltersLabel,
      open,
      onClose: this.closeFilters,
      onEntered: this.setReadyForFocus(true),
      onExit: this.setReadyForFocus(false)
    }, filtersMobileHeaderMarkup, import_react164.default.createElement(Scrollable, {
      className: filtersMobileContainerContentClassName,
      shadow: true
    }, filtersContentMarkup, filtersMobileFooterMarkup)) : import_react164.default.createElement(Sheet, {
      accessibilityLabel: moreFiltersLabel,
      open,
      onClose: this.closeFilters,
      onEntered: this.setReadyForFocus(true),
    ...
    }, filtersDesktopHeaderMarkup, import_react164.default.createElement(Scrollable, {
      className: filtersDesktopContainerContentClassName,
      shadow: true
    }, filtersContentMarkup), filtersDesktopFooterMarkup));
    const helpTextMarkup = helpText ? import_react164.default.createElement("div", {
      id: "FiltersHelpText",
      className: styles66.HelpText
    }, import_react164.default.createElement(TextStyle, {
      variation: "subdued"
    }, helpText)) : null;
    return import_react164.default.createElement(WithinFilterContext.Provider, {
      value: true
    }, import_react164.default.createElement("div", {
      className: styles66.Filters
    }, filtersControlMarkup, filtersContainerMarkup, tagsMarkup, helpTextMarkup, backdropMarkup, import_react164.default.createElement(KeypressListener, {
      keyCode: Key.Escape,
  ...
  generateFilterMarkup(filter) {
    ...
    const clearButtonMarkup = !filter.hideClearButton && import_react164.default.createElement(Button, {
      plain: true,
    ...
    return import_react164.default.createElement("div", {
      ref: this.focusNode
    }, import_react164.default.createElement(Stack, {
      vertical: true,
      spacing: "tight"
...
function Filters(props) {
  ...
  return import_react164.default.createElement(FiltersInner, Object.assign({}, props, {
    i18n,
    mediaQuery
  }));
}
...
function Form({
  ...
  const i18n = useI18n();
  const handleSubmit = (0, import_react166.useCallback)((event) => {
    if (!preventDefault2) {
      return;
    }
    event.preventDefault();
  ...
  const submitMarkup = implicitSubmit ? import_react166.default.createElement(VisuallyHidden, null, import_react166.default.createElement("button", {
    type: "submit",
    "aria-hidden": "true",
    tabIndex: -1
  }, i18n.translate("Polaris.Common.submit"))) : null;
  return import_react166.default.createElement("form", {
    acceptCharset,
    action,
...
function Group({
  ...
  if (helpText) {
    ...
    helpTextElement = import_react168.default.createElement("div", {
      id: helpTextID3,
  ...
  if (title) {
    titleID = `${id}Title`;
    titleElement = import_react168.default.createElement("div", {
      id: titleID,
      className: styles71.Title
    }, title);
  }
  const itemsMarkup = import_react168.Children.map(children2, (child) => wrapWithComponent(child, Item6, {}));
...
// node_modules/@shopify/polaris/build/esm/components/FormLayout/FormLayout.js
var FormLayout = (0, import_react169.memo)(function FormLayout2({
  children: children2
}) {
  return import_react169.default.createElement("div", {
    className: styles71.FormLayout
  }, import_react169.Children.map(children2, wrapChildren));
});
...
function useIsMountedRef() {
  const isMounted = (0, import_react170.useRef)(false);
...
function Loading2() {
  ...
  const [progress, setProgress] = (0, import_react171.useState)(0);
  const [animating, setAnimating] = (0, import_react171.useState)(false);
...
function CSSAnimation({
  ...
  const [transitionStatus, setTransitionStatus] = (0, import_react172.useState)(inProp ? TransitionStatus2.Entering : TransitionStatus2.Exited);
  const isMounted = (0, import_react172.useRef)(false);
  const node = (0, import_react172.useRef)(null);
...
function Dialog({
  ...
  const containerNode = (0, import_react173.useRef)(null);
  ...
  return import_react173.default.createElement(TransitionChild, Object.assign({}, props, {
    ...
    "data-polaris-overlay": true,
    ref: containerNode
  }, import_react173.default.createElement(TrapFocus, null, import_react173.default.createElement("div", {
    role: "dialog",
    "aria-modal": true,
    ...
    className: classes
  }, import_react173.default.createElement(KeypressListener, {
    keyCode: Key.Escape,
    handler: onClose
  }), children2)))));
}
...
function FadeUp({
  ...
  return import_react173.default.createElement(CSSTransition_default, Object.assign({}, props, {
...
function Header3({
  ...
  }, import_react175.default.createElement(DisplayText, {
    element: "h2",
    size: "small"
  }, children2)), import_react175.default.createElement(CloseButton, {
    titleHidden,
    onClick: onClose
  }));
}
...
function Section5({
  ...
  return import_react176.default.createElement("section", {
    className
  }, children2);
}
...
function Footer({
  ...
  const actions = primaryActionButton || secondaryActionButtons ? import_react177.default.createElement(ButtonGroup, null, secondaryActionButtons, primaryActionButton) : null;
  ...
  }, import_react177.default.createElement(Stack, {
    alignment: "center"
  }, import_react177.default.createElement(Stack.Item, {
    fill: true
  }, children2), actions)));
}
...
var Modal = function Modal2({
  ...
  const [iframeHeight, setIframeHeight] = (0, import_react178.useState)(IFRAME_LOADING_HEIGHT);
  const headerId = useUniqueId("modal-header");
  const activatorRef = (0, import_react178.useRef)(null);
  const i18n = useI18n();
  const iframeTitle = i18n.translate("Polaris.Modal.iFrameTitle");
  let dialog;
  let backdrop;
  const handleEntered = (0, import_react178.useCallback)(() => {
    if (onTransitionEnd) {
      onTransitionEnd();
    }
  }, [onTransitionEnd]);
  const handleExited = (0, import_react178.useCallback)(() => {
  ...
  const handleIFrameLoad = (0, import_react178.useCallback)((evt) => {
  ...
  if (open) {
    const footerMarkup = !footer && !primaryAction && !secondaryActions ? null : import_react178.default.createElement(Footer, {
      primaryAction,
      secondaryActions
    }, footer);
    ...
    const body = loading ? import_react178.default.createElement("div", {
      className: styles76.Spinner
    }, import_react178.default.createElement(Spinner, null)) : content;
    const scrollContainerMarkup = noScroll ? import_react178.default.createElement("div", {
      className: styles76.Body
    }, body) : import_react178.default.createElement(Scrollable, {
      shadow: true,
      className: styles76.Body,
      onScrolledToBottom
    }, body);
    const bodyMarkup = src ? import_react178.default.createElement("iframe", {
      name: iFrameName,
      title: iframeTitle,
      src,
    ...
    dialog = import_react178.default.createElement(Dialog, {
      instant,
      labelledBy: headerId,
      onClose,
      ...
      limitHeight,
      fullScreen
    }, import_react178.default.createElement(Header3, {
      titleHidden,
      id: headerId,
      onClose
    ...
    backdrop = import_react178.default.createElement(Backdrop, {
      onClick: onClose
    });
  }
  const animated = !instant;
  const activatorMarkup = activator && !isRef3(activator) ? import_react178.default.createElement("div", {
    ref: activatorRef
  }, activator) : null;
  return import_react178.default.createElement(WithinContentContext.Provider, {
    value: true
  }, activatorMarkup, import_react178.default.createElement(Portal, {
    idPrefix: "modal"
  }, import_react178.default.createElement(TransitionGroup_default, {
    appear: animated,
    enter: animated,
    exit: animated
  }, dialog), backdrop));
...
function DiscardConfirmationModal({
  ...
  const i18n = useI18n();
  return import_react179.default.createElement(Modal, {
...
function ContextualSaveBar3({
  ...
  const handleDiscardAction = (0, import_react180.useCallback)(() => {
  ...
  const discardConfirmationModalMarkup = discardAction && discardAction.onAction && discardAction.discardConfirmationModal && import_react180.default.createElement(DiscardConfirmationModal, {
    open: discardConfirmationModalVisible,
    onCancel: toggleDiscardConfirmationModal,
    onDiscard: handleDiscardAction
  });
  const discardActionMarkup = discardAction && import_react180.default.createElement(Button, {
  ...
  const saveActionMarkup = saveAction && import_react180.default.createElement(Button, {
    primary: true,
    url: saveAction.url,
  ...
  const imageMarkup = logo && import_react180.default.createElement(Image, {
    style: {
      width
    },
  ...
  const logoMarkup = alignContentFlush || contextControl ? null : import_react180.default.createElement("div", {
    className: styles75.LogoContainer,
    style: {
      width
    }
  }, imageMarkup);
  const contextControlMarkup = contextControl ? import_react180.default.createElement("div", {
    className: styles75.ContextControl
  }, contextControl) : null;
  const contentsClassName = classNames(styles75.Contents, fullWidth && styles75.fullWidth);
  return import_react180.default.createElement(import_react180.default.Fragment, null, import_react180.default.createElement(CustomProperties, {
    colorScheme: "dark"
  }, import_react180.default.createElement("div", {
    className: styles75.ContextualSaveBar
  }, contextControlMarkup, logoMarkup, import_react180.default.createElement("div", {
    className: contentsClassName
  }, import_react180.default.createElement("h2", {
    className: styles75.Message
  }, message), import_react180.default.createElement("div", {
    className: styles75.ActionContainer
  }, import_react180.default.createElement(Stack, {
    spacing: "tight",
    wrap: false
...
function useDeepCompareRef(dependencies, comparator = import_react_fast_compare2.default) {
  const dependencyList = (0, import_react181.useRef)(dependencies);
...
function useDeepEffect(callback, dependencies, customCompare) {
  (0, import_react182.useEffect)(callback, useDeepCompareRef(dependencies, customCompare));
}
...
function useDeepCallback(callback, dependencies, customCompare) {
  return (0, import_react183.useCallback)(callback, useDeepCompareRef(dependencies, customCompare));
}
...
function Toast({
  ...
  const dismissMarkup = import_react184.default.createElement("button", {
    type: "button",
    className: styles83.CloseButton,
    onClick: onDismiss
  }, import_react184.default.createElement(Icon, {
    source: SvgMobileCancelMajor
  }));
  const actionMarkup = action ? import_react184.default.createElement("div", {
  ...
  return import_react184.default.createElement(CustomProperties, {
    colorScheme: "dark"
  }, import_react184.default.createElement("div", {
    className
  }, import_react184.default.createElement(KeypressListener, {
    keyCode: Key.Escape,
    handler: onDismiss
...
// node_modules/@shopify/polaris/build/esm/components/Frame/components/ToastManager/ToastManager.js
var ToastManager = (0, import_react185.memo)(function ToastManager2({
  toastMessages
}) {
  const toastNodes = [];
  ...
  const toastsMarkup = toastMessages.map((toast, index) => {
    const toastNode = (0, import_react185.createRef)();
    toastNodes[index] = toastNode;
    return import_react185.default.createElement(CSSTransition_default, {
      ...
      ref: toastNode
    }, import_react185.default.createElement(Toast, toast)));
  });
  return import_react185.default.createElement(Portal, null, import_react185.default.createElement(EventListener, {
    event: "resize",
    handler: updateToasts
  }), import_react185.default.createElement("div", {
    className: styles82.ToastManager,
    "aria-live": "assertive"
  }, import_react185.default.createElement(TransitionGroup_default, {
    component: null
  }, toastsMarkup)));
});
var toastClasses = {
...
var FrameInner = class extends import_react186.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      skipFocused: false,
    ...
    this.navigationNode = (0, import_react186.createRef)();
  ...
  render() {
    ...
    const navigationMarkup = navigation ? import_react186.default.createElement(TrapFocus, {
      trapping: mobileNavShowing
    }, import_react186.default.createElement(CSSTransition_default, {
    ...
    }, import_react186.default.createElement("div", Object.assign({
      key: "NavContent"
    }, mobileNavAttributes, {
    ...
    }), navigation, import_react186.default.createElement("button", {
      type: "button",
    ...
    const loadingMarkup = loadingStack > 0 ? import_react186.default.createElement("div", {
      className: styles72.LoadingBar,
      id: APP_FRAME_LOADING_BAR
    }, import_react186.default.createElement(Loading2, null)) : null;
    const contextualSaveBarMarkup = import_react186.default.createElement(CSSAnimation, {
      in: showContextualSaveBar,
      className: styles72.ContextualSaveBar,
      type: "fade"
    }, import_react186.default.createElement(ContextualSaveBar3, this.contextualSaveBar));
    const topBarMarkup = topBar ? import_react186.default.createElement("div", Object.assign({
      className: styles72.TopBar
    }, layer.props, dataPolarisTopBar.props, {
      id: APP_FRAME_TOP_BAR
    }), topBar) : null;
    const globalRibbonMarkup = globalRibbon ? import_react186.default.createElement("div", {
    ...
    const skipMarkup = import_react186.default.createElement("div", {
      className: skipClassName
    }, import_react186.default.createElement("a", {
      href: `#${skipTarget}`,
    ...
    const navigationOverlayMarkup = showMobileNavigation && isNavigationCollapsed ? import_react186.default.createElement(Backdrop, {
    ...
    return import_react186.default.createElement(FrameContext.Provider, {
      value: context
    }, import_react186.default.createElement("div", Object.assign({
      className: frameClassName
    }, layer.props, navigationAttributes), skipMarkup, topBarMarkup, navigationMarkup, contextualSaveBarMarkup, loadingMarkup, navigationOverlayMarkup, import_react186.default.createElement("main", {
      className: styles72.Main,
      id: APP_FRAME_MAIN,
      "data-has-global-ribbon": Boolean(globalRibbon)
    }, import_react186.default.createElement("div", {
      className: styles72.Content
    }, children2)), import_react186.default.createElement(ToastManager, {
      toastMessages
    }), globalRibbonMarkup, import_react186.default.createElement(EventListener, {
      event: "resize",
      handler: this.handleResize
    })));
  }
...
function Frame(props) {
  const i18n = useI18n();
  const mediaQuery = useMediaQuery();
  return import_react186.default.createElement(FrameInner, Object.assign({}, props, {
    i18n,
    mediaQuery
  }));
}
...
function FullscreenBar({
  ...
  }, import_react187.default.createElement("button", {
...
var IndexContext = (0, import_react190.createContext)(void 0);
var IndexSelectionChangeContext = (0, import_react190.createContext)(void 0);
var IndexRowContext = (0, import_react190.createContext)(void 0);

// node_modules/@shopify/polaris/build/esm/utilities/index-provider/hooks.js
function useIndexSelectionChange() {
  const onSelectionChange = (0, import_react191.useContext)(IndexSelectionChangeContext);
...
function useIndexRow() {
  const indexRow = (0, import_react191.useContext)(IndexRowContext);
  if (!indexRow) {
    throw new Error(`Missing IndexProvider context`);
  }
  return indexRow;
...
function useIndexValue() {
  const index = (0, import_react191.useContext)(IndexContext);
  if (!index) {
    throw new Error(`Missing IndexProvider context`);
  }
  return index;
...
function useHandleBulkSelection({
  ...
  const lastSelected = (0, import_react191.useRef)(null);
  const handleSelectionChange = (0, import_react191.useCallback)((selectionType, toggleType, selection, sortOrder) => {
...
function IndexProvider({
  ...
  const contextValue = (0, import_react192.useMemo)(() => ({
    itemCount,
  ...
  const rowContextValue = (0, import_react192.useMemo)(() => ({
    selectable: isSelectableIndex,
    selectMode: selectMode && isSelectableIndex,
    condensed
  }), [condensed, selectMode, isSelectableIndex]);
  return import_react192.default.createElement(IndexContext.Provider, {
    value: contextValue
  }, import_react192.default.createElement(IndexRowContext.Provider, {
    value: rowContextValue
  }, import_react192.default.createElement(IndexSelectionChangeContext.Provider, {
...
var Cell3 = (0, import_react193.memo)(function Cell4({
  children: children2,
  className,
  flush
}) {
  const cellClassName = classNames(className, styles87.TableCell, flush && styles87["TableCell-flush"]);
  return import_react193.default.createElement("td", {
...
var RowContext = (0, import_react194.createContext)({});
var RowHoveredContext = (0, import_react194.createContext)(void 0);
var scrollDefaultContext = {
  scrollableContainer: null,
  canScrollLeft: false,
  canScrollRight: false
};
var ScrollContext = (0, import_react194.createContext)(scrollDefaultContext);

// node_modules/@shopify/polaris/build/esm/components/IndexTable/components/Checkbox/Checkbox.js
var Checkbox3 = (0, import_react195.memo)(function Checkbox4() {
  const i18n = useI18n();
  const {
    resourceName,
    condensed
  ...
  const {
    ...
    selected,
    onInteraction
  } = (0, import_react195.useContext)(RowContext);
  const wrapperClassName = classNames(styles88.Wrapper, condensed ? styles88.condensed : styles88.expanded);
  const Wrapper = condensed ? import_react195.Fragment : CheckboxWrapper;
  return import_react195.default.createElement(Wrapper, null, import_react195.default.createElement("div", {
    className: styles88.TableCellContentContainer
  }, import_react195.default.createElement("div", {
    className: wrapperClassName,
    onClick: onInteraction,
    onKeyUp: noop10
  }, import_react195.default.createElement(Checkbox, {
    id: itemId,
...
function CheckboxWrapper({
  ...
  const checkboxNode = (0, import_react195.useRef)(null);
  const handleResize = (0, import_react195.useCallback)(() => {
...
// node_modules/@shopify/polaris/build/esm/components/IndexTable/components/Row/Row.js
var Row = (0, import_react196.memo)(function Row2({
  children: children2,
  selected,
  id,
  position,
  ...
  const handleInteraction = (0, import_react196.useCallback)((event) => {
    event.stopPropagation();
  ...
  const contextValue = (0, import_react196.useMemo)(() => ({
    itemId: id,
    selected,
    onInteraction: handleInteraction
  }), [id, selected, handleInteraction]);
  const primaryLinkElement = (0, import_react196.useRef)(null);
  const isNavigating = (0, import_react196.useRef)(false);
  const tableRowRef = (0, import_react196.useRef)(null);
  const tableRowCallbackRef = (0, import_react196.useCallback)((node) => {
  ...
  const checkboxMarkup = selectable ? import_react196.default.createElement(Checkbox3, null) : null;
  return import_react196.default.createElement(RowContext.Provider, {
    value: contextValue
  }, import_react196.default.createElement(RowHoveredContext.Provider, {
    value: hovered
  }, import_react196.default.createElement(RowWrapper, {
    key: id,
...
function ScrollContainer({
  ...
  const [containerScroll, setContainerScroll] = (0, import_react197.useState)(scrollDefaultContext);
  const handleScroll = (0, import_react197.useCallback)(debounce(() => {
    if (!scrollableContainerRef.current) {
      return;
    }
  ...
  return import_react197.default.createElement(ScrollContext.Provider, {
...
function IndexTableBase({
  ...
  const tablePosition = (0, import_react198.useRef)({
    top: 0,
    left: 0
  });
  const tableHeadingRects = (0, import_react198.useRef)([]);
  const scrollableContainerElement = (0, import_react198.useRef)(null);
  const tableElement = (0, import_react198.useRef)(null);
  const condensedListElement = (0, import_react198.useRef)(null);
  const [tableInitialized, setTableInitialized] = (0, import_react198.useState)(false);
  const [isSmallScreenSelectable, setIsSmallScreenSelectable] = (0, import_react198.useState)(false);
  const [stickyWrapper, setStickyWrapper] = (0, import_react198.useState)(null);
  const [hideScrollContainer, setHideScrollContainer] = (0, import_react198.useState)(false);
  const tableHeadings = (0, import_react198.useRef)([]);
  const stickyTableHeadings = (0, import_react198.useRef)([]);
  const stickyHeaderWrapperElement = (0, import_react198.useRef)(null);
  const firstStickyHeaderElement = (0, import_react198.useRef)(null);
  const stickyHeaderElement = (0, import_react198.useRef)(null);
  const scrollBarElement = (0, import_react198.useRef)(null);
  const scrollContainerElement = (0, import_react198.useRef)(null);
  const scrollingWithBar = (0, import_react198.useRef)(false);
  const scrollingContainer = (0, import_react198.useRef)(false);
  const tableBodyRef = (0, import_react198.useCallback)((node) => {
    if (node !== null && !tableInitialized) {
      setTableInitialized(true);
    }
  }, [tableInitialized]);
  const toggleIsSmallScreenSelectable = (0, import_react198.useCallback)(() => {
    setIsSmallScreenSelectable((value) => !value);
  }, []);
  const handleSelectAllItemsInStore = (0, import_react198.useCallback)(() => {
  ...
  const calculateFirstHeaderOffset = (0, import_react198.useCallback)(() => {
    if (!selectable) {
  ...
  const resizeTableHeadings = (0, import_react198.useMemo)(() => debounce(() => {
  ...
  const resizeTableScrollBar = (0, import_react198.useCallback)(() => {
  ...
  const debounceResizeTableScrollbar = (0, import_react198.useCallback)(debounce(resizeTableScrollBar, SCROLL_BAR_DEBOUNCE_PERIOD, {
    trailing: true
  }), [resizeTableScrollBar]);
  const [canScrollRight, setCanScrollRight] = (0, import_react198.useState)(true);
  const handleCanScrollRight = (0, import_react198.useCallback)(() => {
  ...
  const handleResize = (0, import_react198.useCallback)(() => {
  ...
  const handleScrollContainerScroll = (0, import_react198.useCallback)((canScrollLeft, canScrollRight2) => {
  ...
  const handleScrollBarScroll = (0, import_react198.useCallback)(() => {
    if (!scrollableContainerElement.current || !scrollBarElement.current) {
      return;
    }
  ...
  const stickyColumnHeader = import_react198.default.createElement("div", {
    className: styles87.TableHeading,
    key: headings[0].title,
    style: stickyColumnHeaderStyle,
    "data-index-table-sticky-heading": true
  }, import_react198.default.createElement(Stack, {
    spacing: "none",
    wrap: false,
    alignment: "center"
  }, selectable && import_react198.default.createElement("div", {
    className: styles87.FirstStickyHeaderElement,
    ref: firstStickyHeaderElement
  }, renderCheckboxContent()), selectable && import_react198.default.createElement("div", {
    className: styles87["StickyTableHeading-second-scrolling"]
  }, renderHeadingContent(headings[0])), !selectable && import_react198.default.createElement("div", {
    className: styles87.FirstStickyHeaderElement,
    ref: firstStickyHeaderElement
  }, renderHeadingContent(headings[0]))));
  const stickyHeadingsMarkup = headings.map(renderStickyHeading);
  const selectedItemsCountLabel = selectedItemsCount === SELECT_ALL_ITEMS ? `${itemCount}+` : selectedItemsCount;
  const handleTogglePage = (0, import_react198.useCallback)(() => {
  ...
  const loadingMarkup = import_react198.default.createElement(CSSTransition_default, {
    in: loading,
  ...
  }, import_react198.default.createElement(Spinner, {
    size: "small"
  ...
  const stickyHeaderMarkup = import_react198.default.createElement("div", {
    className: stickyTableClassNames,
    role: "presentation"
  }, import_react198.default.createElement(Sticky, {
    ...
    const bulkActionsMarkup = shouldShowBulkActions ? import_react198.default.createElement("div", {
      className: bulkActionClassNames,
      "data-condensed": condensed
    }, loadingMarkup, import_react198.default.createElement(BulkActions, {
    ...
    const selectButtonMarkup = import_react198.default.createElement(Button, {
      icon: SvgEnableSelectionMinor,
      onClick: toggleIsSmallScreenSelectable
    }, i18n.translate("Polaris.IndexTable.selectButtonText"));
    const headerMarkup = condensed ? import_react198.default.createElement("div", {
      className: classNames(styles87.HeaderWrapper, !selectable && styles87.unselectable)
    }, loadingMarkup, sort, selectable && selectButtonMarkup) : import_react198.default.createElement("div", {
      className: stickyHeaderClassNames,
      ref: stickyHeaderWrapperElement
    }, loadingMarkup, import_react198.default.createElement("div", {
      className: stickyColumnHeaderClassNames
    }, stickyColumnHeader), import_react198.default.createElement("div", {
  ...
  const scrollBarMarkup = itemCount > 0 ? import_react198.default.createElement(AfterInitialMount, null, import_react198.default.createElement("div", {
  ...
  const emptyStateMarkup = emptyState ? emptyState : import_react198.default.createElement(EmptySearchResult, {
  ...
  const sharedMarkup = import_react198.default.createElement(import_react198.default.Fragment, null, import_react198.default.createElement(EventListener, {
    event: "resize",
    handler: handleResize
  }), import_react198.default.createElement(AfterInitialMount, null, stickyHeaderMarkup));
  const bodyMarkup = condensed ? import_react198.default.createElement(import_react198.default.Fragment, null, sharedMarkup, import_react198.default.createElement("ul", {
    "data-selectmode": Boolean(selectMode || isSmallScreenSelectable),
    className: styles87.CondensedList,
    ref: condensedListElement
  }, children2)) : import_react198.default.createElement(import_react198.default.Fragment, null, sharedMarkup, import_react198.default.createElement(ScrollContainer, {
    scrollableContainerRef: scrollableContainerElement,
    onScroll: handleScrollContainerScroll
  }, import_react198.default.createElement("table", {
    ref: tableElement,
    className: tableClassNames
  }, import_react198.default.createElement("thead", null, import_react198.default.createElement("tr", {
    className: styles87.HeadingRow
  }, headingsMarkup)), import_react198.default.createElement("tbody", {
    ref: tableBodyRef
  }, children2))));
  const tableContentMarkup = itemCount > 0 ? bodyMarkup : import_react198.default.createElement("div", {
    className: styles87.EmptySearchResultWrapper
  }, emptyStateMarkup);
  return import_react198.default.createElement(import_react198.default.Fragment, null, import_react198.default.createElement("div", {
  ...
  function renderHeading(heading, index) {
    ...
    const headingContent = import_react198.default.createElement("th", {
    ...
    const checkboxContent = import_react198.default.createElement("th", {
      className: checkboxClassName,
      key: `${heading}-${index}`,
      "data-index-table-heading": true
  ...
  function renderCheckboxContent() {
    ...
    }, import_react198.default.createElement(Checkbox, {
  ...
  function renderHeadingContent(heading) {
    let headingContent;
    if (heading.new) {
      headingContent = import_react198.default.createElement(Stack, {
        wrap: false,
        alignment: "center"
      }, import_react198.default.createElement("span", null, heading.title), import_react198.default.createElement(Badge, {
        status: "new"
      }, i18n.translate("Polaris.IndexTable.onboardingBadgeText")));
    } else if (heading.hidden) {
      headingContent = import_react198.default.createElement(VisuallyHidden, null, heading.title);
    } else {
...
function IndexTable({
  ...
  return import_react198.default.createElement(IndexProvider, {
    selectable,
    itemCount,
    selectedItemsCount,
    resourceName: passedResourceName,
    ...
    condensed,
    onSelectionChange
  }, import_react198.default.createElement(IndexTableBase, indexTableBaseProps, children2));
}
...
function KeyboardKey({
  ...
  return import_react199.default.createElement("kbd", {
...
function KonamiCode({
  ...
  const [position, setPosition] = (0, import_react200.useState)(0);
...
function AnnotatedSection(props) {
  ...
  const descriptionMarkup = typeof description === "string" ? import_react201.default.createElement("p", null, description) : description;
  ...
  }, import_react201.default.createElement(TextContainer, null, import_react201.default.createElement(Heading, {
    id
  }, title), descriptionMarkup && import_react201.default.createElement("div", {
    className: styles91.AnnotationDescription
  }, descriptionMarkup))), import_react201.default.createElement("div", {
...
var Layout = function Layout2({
  ...
  const content = sectioned ? import_react203.default.createElement(Section6, null, children2) : children2;
...
function Link({
  ...
  if (external && typeof children2 === "string") {
    ...
    childrenMarkup = import_react204.default.createElement(import_react204.default.Fragment, null, children2, import_react204.default.createElement("span", {
      className: styles92.IconLockup
    }, import_react204.default.createElement("span", {
      className: styles92.IconLayout
    }, import_react204.default.createElement(Icon, {
      accessibilityLabel: iconLabel,
      source: SvgExternalSmallMinor
    }))));
  }
  return import_react204.default.createElement(BannerContext.Consumer, null, (BannerContext2) => {
    ...
    return url ? import_react204.default.createElement(UnstyledLink, {
      onClick,
      className,
      url,
      external,
      id,
      "aria-label": accessibilityLabel
    }, childrenMarkup) : import_react204.default.createElement("button", {
      type: "button",
      onClick,
      className,
      id,
...
var List = function List2({
  ...
  return import_react206.default.createElement(ListElement, {
    className
  }, children2);
};
List.Item = Item7;
...
var Loading3 = (0, import_react207.memo)(function Loading4() {
  const {
    startLoading,
    stopLoading
  } = useFrame();
...
function MediaCard({
  ...
  if (title) {
    const headerContent = typeof title === "string" ? import_react208.default.createElement(Heading, null, title) : title;
    headerMarkup = import_react208.default.createElement("div", {
      className: styles94.Heading
    }, headerContent);
  }
  const popoverActivator = import_react208.default.createElement(Button, {
    icon: SvgHorizontalDotsMinor,
  ...
  const popoverActionsMarkup = popoverActions.length > 0 ? import_react208.default.createElement("div", {
    className: styles94.Popover
  }, import_react208.default.createElement(Popover2, {
    active: popoverActive,
    activator: popoverActivator,
    onClose: togglePopoverActive,
    preferredAlignment: "left",
    preferredPosition: "below"
  }, import_react208.default.createElement(ActionList, {
    items: popoverActions,
    onActionAnyItem: togglePopoverActive
  }))) : null;
  const primaryActionMarkup = primaryAction ? import_react208.default.createElement("div", {
    className: styles94.PrimaryAction
  }, buttonFrom(primaryAction)) : null;
  const secondaryActionMarkup = secondaryAction ? import_react208.default.createElement("div", {
  ...
  const actionMarkup = primaryActionMarkup || secondaryActionMarkup ? import_react208.default.createElement("div", {
    className: actionClassName
  }, import_react208.default.createElement(ButtonGroup, null, primaryActionMarkup, secondaryActionMarkup)) : null;
  ...
  return import_react208.default.createElement(Card, null, import_react208.default.createElement("div", {
    className: mediaCardClassName
  }, import_react208.default.createElement("div", {
    className: mediaContainerClassName
  }, children2), import_react208.default.createElement("div", {
    className: infoContainerClassName
  }, import_react208.default.createElement(Card.Section, null, popoverActionsMarkup, import_react208.default.createElement(Stack, {
    vertical: true,
    spacing: "tight"
  }, headerMarkup, import_react208.default.createElement("p", {
...
var NavigationContext = (0, import_react209.createContext)({
  location: ""
});
...
function Secondary({
  ...
  return import_react210.default.createElement(Collapsible, {
    id: id || uid,
    open: expanded,
    transition: {
      duration: "0ms",
  ...
  }, import_react210.default.createElement("ul", {
...
function Item8({
  ...
  const {
    location,
    onNavigationDismiss
  } = (0, import_react211.useContext)(NavigationContext);
  const [keyFocused, setKeyFocused] = (0, import_react211.useState)(false);
  ...
  const handleKeyUp = (0, import_react211.useCallback)((event) => {
    if (event.keyCode === Key.Tab) {
      !keyFocused && setKeyFocused(true);
    }
  }, [keyFocused]);
  const handleBlur = (0, import_react211.useCallback)(() => {
  ...
  const indicatorMarkup = hasNewChild ? import_react211.default.createElement("span", {
    className: styles95.Indicator
  }, import_react211.default.createElement(Indicator, {
    pulse: true
  })) : null;
  const iconMarkup = icon ? import_react211.default.createElement("div", {
  ...
  const externalLinkIconMarkup = external ? import_react211.default.createElement("div", {
  ...
  if (isNew) {
    badgeMarkup = import_react211.default.createElement(Badge, {
      status: "new",
      size: "small"
  ...
  const wrappedBadgeMarkup = badgeMarkup == null ? null : import_react211.default.createElement("div", {
    className: styles95.Badge
  }, badgeMarkup);
  const itemContentMarkup = import_react211.default.createElement(import_react211.default.Fragment, null, iconMarkup, import_react211.default.createElement("span", {
  ...
  if (url == null) {
    ...
    }, import_react211.default.createElement("button", {
      type: "button",
  ...
  const secondaryActionLinkMarkup = secondaryAction && import_react211.default.createElement(UnstyledLink, {
    external: true,
  ...
  const secondaryActionMarkup = secondaryAction && (secondaryAction.tooltip ? import_react211.default.createElement(Tooltip, secondaryAction.tooltip, secondaryActionLinkMarkup) : secondaryActionLinkMarkup);
  ...
  if (subNavigationItems.length > 0) {
    ...
    secondaryNavigationMarkup = import_react211.default.createElement("div", {
      className: SecondaryNavigationClassName
    }, import_react211.default.createElement(Secondary, {
      ...
      return import_react211.default.createElement(Item8, Object.assign({
        key: label2
      }, rest, {
        label: label2,
  ...
  }, import_react211.default.createElement(UnstyledLink, Object.assign({
    url,
...
function Section7({
  ...
  const animationFrame = (0, import_react212.useRef)(null);
  const {
    isNavigationCollapsed
  } = useMediaQuery();
  const [expandedIndex, setExpandedIndex] = (0, import_react212.useState)();
  ...
  const buttonMarkup = action && import_react212.default.createElement("button", {
    type: "button",
  ...
  const actionMarkup = action && (action.tooltip ? import_react212.default.createElement(Tooltip, action.tooltip, buttonMarkup) : buttonMarkup);
  const sectionHeadingMarkup = title && import_react212.default.createElement("li", {
  ...
  const itemsMarkup = items.map((item, index) => {
    ...
    return import_react212.default.createElement(Item8, Object.assign({
      key: label
    }, rest, {
      label,
      subNavigationItems,
  ...
  const toggleRollup = rollup && items.length > rollup.after && import_react212.default.createElement("div", {
    className: styles95.ListItem,
    key: "List Item"
  ...
  const activeItemsMarkup = rollup && additionalItems.length > 0 && import_react212.default.createElement("li", {
    className: styles95.RollupSection
  }, import_react212.default.createElement(Collapsible, {
...
var Navigation2 = function Navigation3({
  ...
  const width = getWidth(logo, 104);
  const logoMarkup = logo ? import_react213.default.createElement("div", {
    className: classNames(styles95.LogoContainer, logoSuffix && styles95.hasLogoSuffix)
  }, import_react213.default.createElement(UnstyledLink, {
    url: logo.url || "",
    className: styles95.LogoLink,
    style: {
      width
    }
  }, import_react213.default.createElement(Image, {
  ...
  const mediaMarkup = contextControl ? import_react213.default.createElement("div", {
    className: styles95.ContextControl
  }, contextControl) : logoMarkup;
  const context = (0, import_react213.useMemo)(() => ({
    location,
    onNavigationDismiss: onDismiss
  }), [location, onDismiss]);
  return import_react213.default.createElement(NavigationContext.Provider, {
    value: context
  }, import_react213.default.createElement(WithinContentContext.Provider, {
    value: true
  }, import_react213.default.createElement("nav", {
    className: styles95.Navigation,
    "aria-labelledby": ariaLabelledBy
  }, mediaMarkup, import_react213.default.createElement(Scrollable, {
...
function Checkbox5({
  ...
  const id = useUniqueId("Checkbox", idProp);
  const [keyFocused, setKeyFocused] = (0, import_react214.useState)(false);
...
function Option3({
  ...
  const handleClick = (0, import_react215.useCallback)(() => {
    if (disabled) {
      return;
    }
    onClick(section, index);
  }, [disabled, index, onClick, section]);
  const mediaMarkup = media ? import_react215.default.createElement("div", {
  ...
  const optionMarkup = allowMultiple ? import_react215.default.createElement("label", {
    htmlFor: id,
    className: multiSelectClassName
  }, import_react215.default.createElement("div", {
    className: styles97.Checkbox
  }, import_react215.default.createElement(Checkbox5, {
    id,
    value,
    checked: select,
    active,
    ...
    role: checkBoxRole
  })), mediaMarkup, label) : import_react215.default.createElement("button", {
    id,
    type: "button",
  ...
  const scrollMarkup = active ? import_react215.default.createElement(Scrollable.ScrollTo, null) : null;
  return import_react215.default.createElement("li", {
    key: id,
...
function OptionList({
  ...
  const [normalizedOptions, setNormalizedOptions] = (0, import_react216.useState)(createNormalizedOptions(options, sections, title));
  ...
  const handleClick = (0, import_react216.useCallback)((sectionIndex, optionIndex) => {
  ...
  const optionsMarkup = optionsExist ? normalizedOptions.map(({
    ...
    const titleMarkup = title2 ? import_react216.default.createElement("p", {
    ...
    const optionsMarkup2 = options2 && options2.map((option, optionIndex) => {
      ...
      return import_react216.default.createElement(Option3, Object.assign({
        key: optionId
      }, option, {
        id: optionId,
    ...
    return import_react216.default.createElement("li", {
      key: title2 || `noTitle-${sectionIndex}`
    }, titleMarkup, import_react216.default.createElement("ul", {
...
function isInterface(x) {
  return !(0, import_react217.isValidElement)(x) && x !== void 0;
}
...
function isReactElement(x) {
  return (0, import_react218.isValidElement)(x) && x !== void 0;
}
...
function Pagination({
  ...
  const i18n = useI18n();
  const node = (0, import_react219.createRef)();
  ...
  const prev = import_react219.default.createElement(Button, {
    outline: true,
    icon: SvgChevronLeftMinor,
  ...
  const constructedPrevious = previousTooltip && hasPrevious ? import_react219.default.createElement(Tooltip, {
    activatorWrapper: "span",
    content: previousTooltip
  }, prev) : prev;
  const next = import_react219.default.createElement(Button, {
    outline: true,
    icon: SvgChevronRightMinor,
  ...
  const constructedNext = nextTooltip && hasNext ? import_react219.default.createElement(Tooltip, {
    activatorWrapper: "span",
    content: nextTooltip
  }, next) : next;
  const previousHandler = onPrevious || noop11;
  const previousButtonEvents = previousKeys && (previousURL || onPrevious) && hasPrevious && previousKeys.map((key) => import_react219.default.createElement(KeypressListener, {
    key,
    keyCode: key,
    handler: previousURL ? handleCallback(clickPaginationLink("previousURL", node)) : handleCallback(previousHandler)
  }));
  const nextHandler = onNext || noop11;
  const nextButtonEvents = nextKeys && (nextURL || onNext) && hasNext && nextKeys.map((key) => import_react219.default.createElement(KeypressListener, {
    key,
    keyCode: key,
    handler: nextURL ? handleCallback(clickPaginationLink("nextURL", node)) : handleCallback(nextHandler)
  }));
  const labelTextMarkup = hasNext && hasPrevious ? import_react219.default.createElement(TextStyle, null, label) : import_react219.default.createElement(TextStyle, {
    variation: "subdued"
  }, label);
  const labelMarkup = label ? import_react219.default.createElement("div", {
    "aria-live": "polite"
  }, labelTextMarkup) : null;
  return import_react219.default.createElement("nav", {
    "aria-label": navLabel,
    ref: node
  }, previousButtonEvents, nextButtonEvents, import_react219.default.createElement(ButtonGroup, {
    segmented: !label
...
function Title({
  ...
  const titleMarkup = title ? import_react220.default.createElement("h1", {
    className
  }, title) : null;
  const titleMetadataMarkup = titleMetadata ? import_react220.default.createElement("div", {
    className: styles101.TitleMetadata
  }, titleMetadata) : null;
  const wrappedTitleMarkup = titleMetadata ? import_react220.default.createElement("div", {
    className: styles101.TitleWithMetadataWrapper
  }, titleMarkup, titleMetadataMarkup) : titleMarkup;
  const subtitleMarkup = subtitle ? import_react220.default.createElement("div", {
    className: classNames(styles101.SubTitle, compactTitle && styles101.SubtitleCompact)
  }, import_react220.default.createElement("p", null, subtitle)) : null;
  return import_react220.default.createElement(import_react220.default.Fragment, null, wrappedTitleMarkup, subtitleMarkup);
}
...
function Header4({
  ...
  const breadcrumbMarkup = breadcrumbs.length > 0 ? import_react221.default.createElement("div", {
    className: styles100.BreadcrumbWrapper
  }, import_react221.default.createElement(Breadcrumbs, {
    breadcrumbs
  })) : null;
  const paginationMarkup = pagination && !isNavigationCollapsed ? import_react221.default.createElement("div", {
    className: styles100.PaginationWrapper
  }, import_react221.default.createElement(Pagination, pagination)) : null;
  const additionalNavigationMarkup = additionalNavigation ? import_react221.default.createElement("div", {
    className: styles100.AdditionalNavigationWrapper
  }, additionalNavigation) : null;
  const navigationMarkup = breadcrumbMarkup || paginationMarkup || additionalNavigationMarkup ? import_react221.default.createElement("div", {
    className: styles100.Navigation
  }, breadcrumbMarkup, additionalNavigationMarkup, paginationMarkup) : null;
  const pageTitleMarkup = import_react221.default.createElement("div", {
    className: styles100.TitleWrapper
  }, import_react221.default.createElement(Title, {
    title,
    subtitle,
    titleMetadata,
    compactTitle
  }));
  const primaryActionMarkup = primaryAction ? import_react221.default.createElement(PrimaryActionMarkup, {
    primaryAction
  }) : null;
  let actionMenuMarkup = null;
  if (isInterface(secondaryActions) && (secondaryActions.length > 0 || hasGroupsWithActions(actionGroups))) {
    actionMenuMarkup = import_react221.default.createElement(ActionMenu, {
    ...
    actionMenuMarkup = import_react221.default.createElement(import_react221.default.Fragment, null, secondaryActions);
  }
  const additionalMetadataMarkup = additionalMetadata ? import_react221.default.createElement("div", {
    className: styles100.AdditionalMetaData
  }, import_react221.default.createElement(TextStyle, {
    variation: "subdued"
  ...
  }, import_react221.default.createElement(ConditionalRender, {
    condition: [slot1, slot2, slot3, slot4].some(notNull)
  }, import_react221.default.createElement("div", {
    className: styles100.Row
  }, slot1, slot2, import_react221.default.createElement(ConditionalRender, {
    condition: [slot3, slot4].some(notNull)
  }, import_react221.default.createElement("div", {
    className: styles100.RightAlign
  }, import_react221.default.createElement(ConditionalWrapper, {
    condition: [slot3, slot4].every(notNull),
    wrapper: (children2) => import_react221.default.createElement("div", {
      className: styles100.Actions
    }, children2)
  }, slot3, slot4))))), import_react221.default.createElement(ConditionalRender, {
    condition: [slot5, slot6].some(notNull)
  }, import_react221.default.createElement("div", {
    className: styles100.Row
  }, import_react221.default.createElement("div", {
    className: styles100.LeftAlign
  }, slot5), import_react221.default.createElement(ConditionalRender, {
  ...
  const layouts = {
    ...
    desktopDefault: {
      slots: {
        slot1: breadcrumbMarkup,
        slot2: pageTitleMarkup,
        slot3: import_react221.default.createElement(import_react221.default.Fragment, null, actionMenuMarkup, primaryActionMarkup),
...
function Page({
  ...
  const headerMarkup = hasHeaderContent ? import_react222.default.createElement(Header4, rest) : null;
  return import_react222.default.createElement("div", {
    className: pageClassName
  }, headerMarkup, import_react222.default.createElement("div", {
...
function PageActions({
  ...
  if (isReactElement(primaryAction)) {
    primaryActionMarkup = import_react223.default.createElement(import_react223.default.Fragment, null, primaryAction);
  ...
  if (isInterface(secondaryActions) && secondaryActions.length > 0) {
    secondaryActionsMarkup = import_react223.default.createElement(ButtonGroup, null, buttonsFrom(secondaryActions));
  } else if (isReactElement(secondaryActions)) {
    secondaryActionsMarkup = import_react223.default.createElement(import_react223.default.Fragment, null, secondaryActions);
  }
  ...
  }, import_react223.default.createElement(Stack, {
    distribution,
    spacing: "tight"
...
function PolarisTestProvider({
  ...
  const Wrapper = strict ? import_react224.StrictMode : import_react224.Fragment;
  const intl = (0, import_react224.useMemo)(() => new I18n(i18n || {}), [i18n]);
  const scrollLockManager = (0, import_react224.useMemo)(() => new ScrollLockManager(), []);
  const stickyManager = (0, import_react224.useMemo)(() => new StickyManager(), []);
  const uniqueIdFactory = (0, import_react224.useMemo)(() => new UniqueIdFactory(globalIdGeneratorFactory), []);
  const mergedFrame = createFrameContext(frame);
  const mergedMediaQuery = merge(defaultMediaQuery, mediaQuery);
  return import_react224.default.createElement(Wrapper, null, import_react224.default.createElement(FeaturesContext.Provider, {
    value: features
  }, import_react224.default.createElement(I18nContext.Provider, {
    value: intl
  }, import_react224.default.createElement(ScrollLockManagerContext.Provider, {
    value: scrollLockManager
  }, import_react224.default.createElement(StickyManagerContext.Provider, {
    value: stickyManager
  }, import_react224.default.createElement(UniqueIdFactoryContext.Provider, {
    value: uniqueIdFactory
  }, import_react224.default.createElement(LinkContext.Provider, {
    value: link
  }, import_react224.default.createElement(CustomProperties, {
    colorScheme
  }, import_react224.default.createElement(MediaQueryContext.Provider, {
    value: mergedMediaQuery
  }, import_react224.default.createElement(PortalsManager, null, import_react224.default.createElement(FocusManager, null, import_react224.default.createElement(FrameContext.Provider, {
    value: mergedFrame
  }, children2))))))))))));
}
function noop12() {
...
function ProgressBar({
  ...
  return import_react225.default.createElement("div", {
    className
  }, import_react225.default.createElement("progress", {
    className: styles103.Progress,
    value: parsedProgress,
    max: "100"
  }), import_react225.default.createElement(CSSTransition_default, {
    in: true,
    appear: true,
  ...
  }, import_react225.default.createElement("span", {
...
var DualThumb = class extends import_react226.Component {
  constructor(...args) {
    super(...args);
    this.context = void 0;
    this.state = {
    ...
    this.track = (0, import_react226.createRef)();
    this.trackWrapper = (0, import_react226.createRef)();
    this.thumbLower = (0, import_react226.createRef)();
    this.thumbUpper = (0, import_react226.createRef)();
  ...
  render() {
    ...
    const outputMarkupLower = !disabled && output ? import_react226.default.createElement("output", {
      htmlFor: idLower,
    ...
    }, import_react226.default.createElement("span", {
      className: styles104.OutputText
    }, value[0]))) : null;
    const outputUpperClassName = classNames(styles104.Output, styles104.OutputUpper);
    const outputMarkupUpper = !disabled && output ? import_react226.default.createElement("output", {
      htmlFor: idUpper,
    ...
    const prefixMarkup = prefix && import_react226.default.createElement("div", {
      className: styles104.Prefix
    }, prefix);
    const suffixMarkup = suffix && import_react226.default.createElement("div", {
      className: styles104.Suffix
    }, suffix);
    return import_react226.default.createElement(import_react226.default.Fragment, null, import_react226.default.createElement(Labelled, {
      id,
      label,
      error,
      action: labelAction,
    ...
    }, prefixMarkup, import_react226.default.createElement("div", {
      ...
      ref: this.thumbLower
    }), outputMarkupLower, import_react226.default.createElement("div", {
      id: idUpper,
      ...
      ref: this.thumbUpper
    }), outputMarkupUpper), suffixMarkup)), import_react226.default.createElement(EventListener, {
      event: "resize",
...
function SingleThumb(props) {
  ...
  const outputMarkup = !disabled && output && import_react227.default.createElement("output", {
    htmlFor: id,
  ...
  const prefixMarkup = prefix && import_react227.default.createElement("div", {
    className: styles105.Prefix
  }, prefix);
  const suffixMarkup = suffix && import_react227.default.createElement("div", {
  ...
  return import_react227.default.createElement(Labelled, {
    id,
    label,
    error,
    action: labelAction,
    ...
    className,
    style: cssVars
  }, prefixMarkup, import_react227.default.createElement("div", {
    className: styles105.InputWrapper
  }, import_react227.default.createElement("input", {
    type: "range",
...
function RangeSlider({
  ...
  return isDualThumb(value) ? import_react228.default.createElement(DualThumb, Object.assign({
    value
  }, sharedProps)) : import_react228.default.createElement(SingleThumb, Object.assign({
    value
  }, sharedProps));
}
...
var BaseResourceItem = class extends import_react229.Component {
  constructor(...args) {
    super(...args);
    this.state = {
    ...
    this.buttonOverlay = (0, import_react229.createRef)();
    this.setNode = (node) => {
      this.node = node;
    };
    this.handleFocus = (event) => {
  ...
  render() {
    ...
    if (media || selectable) {
      ownedMarkup = import_react229.default.createElement("div", {
    ...
    if (shortcutActions && !loading) {
      if (persistActions) {
        actionsMarkup = import_react229.default.createElement("div", {
          className: styles106.Actions,
          onClick: stopPropagation2
        }, import_react229.default.createElement(ButtonGroup, null, buttonsFrom(shortcutActions, {
          plain: true
        })));
        const disclosureAccessibilityLabel = name ? i18n.translate("Polaris.ResourceList.Item.actionsDropdownLabel", {
          accessibilityLabel: name
        }) : i18n.translate("Polaris.ResourceList.Item.actionsDropdown");
        disclosureMarkup = import_react229.default.createElement("div", {
          className: styles106.Disclosure,
          onClick: stopPropagation2
        }, import_react229.default.createElement(Popover2, {
          activator: import_react229.default.createElement(Button, {
        ...
        }, import_react229.default.createElement(ActionList, {
        ...
        actionsMarkup = import_react229.default.createElement("div", {
          className: styles106.Actions,
          onClick: stopPropagation2
        }, import_react229.default.createElement(ButtonGroup, {
          segmented: true
    ...
    const content = children2 ? import_react229.default.createElement("div", {
    ...
    const containerMarkup = import_react229.default.createElement("div", {
      className: containerClassName,
      id: this.props.id
    ...
    const accessibleMarkup = url ? import_react229.default.createElement(UnstyledLink, {
      ...
      tabIndex,
      id: this.overlayId
    }) : import_react229.default.createElement("button", {
...
function ResourceItem(props) {
  return import_react229.default.createElement(BaseResourceItem, Object.assign({}, props, {
    context: (0, import_react229.useContext)(ResourceListContext),
    i18n: useI18n()
  }));
}
...
function useLazyRef(initialValue) {
  const lazyRef = (0, import_react230.useRef)(UNIQUE_IDENTIFIER);
...
function Select({
  ...
  const inlineLabelMarkup = labelInline && import_react231.default.createElement("span", {
    className: styles108.InlineLabel
  }, label);
  const selectedOption = getSelectedOption(normalizedOptions, value);
  const prefixMarkup = selectedOption.prefix && import_react231.default.createElement("div", {
    className: styles108.Prefix
  }, selectedOption.prefix);
  const contentMarkup = import_react231.default.createElement("div", {
    className: styles108.Content,
    "aria-hidden": true,
    "aria-disabled": disabled
  }, inlineLabelMarkup, prefixMarkup, import_react231.default.createElement("span", {
    className: styles108.SelectedOption
  }, selectedOption.label), import_react231.default.createElement("span", {
    className: styles108.Icon
  }, import_react231.default.createElement(Icon, {
    source: SvgSelectMinor
  })));
  const optionsMarkup = normalizedOptions.map(renderOption);
  return import_react231.default.createElement(Labelled, {
    id,
    label,
    error,
    action: labelAction,
    ...
    className
  }, import_react231.default.createElement("select", {
    id,
    name,
    value,
    ...
    "aria-describedby": describedBy.length ? describedBy.join(" ") : void 0,
    "aria-required": requiredIndicator
  }, optionsMarkup), contentMarkup, import_react231.default.createElement("div", {
...
function renderSingleOption(option) {
  ...
  return import_react231.default.createElement("option", Object.assign({
    key: value,
    value
  }, rest), label);
}
function renderOption(optionOrGroup) {
  if (isGroup(optionOrGroup)) {
    ...
    return import_react231.default.createElement("optgroup", {
      label: title,
      key: title
...
var ResourceList = function ResourceList2({
  ...
  const i18n = useI18n();
  const [selectMode, setSelectMode] = (0, import_react232.useState)(Boolean(selectedItems && selectedItems.length > 0));
  const [loadingPosition, setLoadingPositionState] = (0, import_react232.useState)(0);
  const [lastSelected, setLastSelected] = (0, import_react232.useState)();
  const [smallScreen, setSmallScreen] = (0, import_react232.useState)(isSmallScreen2());
  const forceUpdate = (0, import_react232.useReducer)((x = 0) => x + 1, 0)[1];
  const [checkableButtons, setCheckableButtons] = (0, import_react232.useState)(/* @__PURE__ */ new Map());
  const defaultResourceName = useLazyRef(() => ({
    singular: i18n.translate("Polaris.ResourceList.defaultItemSingular"),
    plural: i18n.translate("Polaris.ResourceList.defaultItemPlural")
  }));
  const listRef = (0, import_react232.useRef)(null);
  ...
  const setLoadingPosition = (0, import_react232.useCallback)(() => {
  ...
  const bulkActionsMarkup = isSelectable ? import_react232.default.createElement("div", {
    className: styles107.BulkActionsWrapper
  }, import_react232.default.createElement(BulkActions, {
  ...
  const filterControlMarkup = filterControl ? import_react232.default.createElement("div", {
    className: styles107.FiltersWrapper
  }, filterControl) : null;
  const sortingSelectMarkup = sortOptions && sortOptions.length > 0 && !alternateTool ? import_react232.default.createElement("div", {
    className: styles107.SortWrapper
  }, import_react232.default.createElement(Select, {
  ...
  const alternateToolMarkup = alternateTool && !sortingSelectMarkup ? import_react232.default.createElement("div", {
    className: styles107.AlternateToolWrapper
  }, alternateTool) : null;
  const headerTitleMarkup = import_react232.default.createElement("div", {
    className: styles107.HeaderTitleWrapper
  }, headerTitle());
  const selectButtonMarkup = isSelectable ? import_react232.default.createElement("div", {
  ...
  const checkableButtonMarkup = isSelectable ? import_react232.default.createElement("div", {
    className: styles107.CheckableButtonWrapper
  }, import_react232.default.createElement(CheckableButton, {
    accessibilityLabel: bulkActionsAccessibilityLabel(),
    label: headerTitle(),
    onToggleAll: handleToggleAll,
    plain: true,
  ...
  const headerWrapperOverlay = loading ? import_react232.default.createElement("div", {
  ...
  const headerMarkup = !showEmptyState && showHeader !== false && !showEmptySearchState && (showHeader || needsHeader) && listRef.current && import_react232.default.createElement("div", {
    className: styles107.HeaderOuterWrapper
  }, import_react232.default.createElement(Sticky, {
    ...
    return import_react232.default.createElement("div", {
      className: headerClassName
    }, import_react232.default.createElement(EventListener, {
      event: "resize",
      handler: handleResize
    }), headerWrapperOverlay, import_react232.default.createElement("div", {
  ...
  const emptySearchStateMarkup = showEmptySearchState ? emptySearchState || import_react232.default.createElement("div", {
    className: styles107.EmptySearchResultWrapper
  }, import_react232.default.createElement(EmptySearchResult, Object.assign({}, emptySearchResultText, {
    withIllustration: true
  }))) : null;
  ...
  const loadingOverlay = loading ? import_react232.default.createElement(import_react232.default.Fragment, null, import_react232.default.createElement("li", {
    className: styles107.SpinnerContainer,
    style: spinnerStyle
  }, import_react232.default.createElement(Spinner, {
    size: spinnerSize,
    accessibilityLabel: "Items are loading"
  })), import_react232.default.createElement("li", {
  ...
  const loadingWithoutItemsMarkup = loading && !itemsExist ? import_react232.default.createElement("div", {
    className,
    tabIndex: -1
  }, loadingOverlay) : null;
  ...
  const listMarkup = itemsExist ? import_react232.default.createElement("ul", {
    className: resourceListClassName,
    ref: listRef,
    "aria-live": "polite",
    "aria-busy": loading
  }, loadingOverlay, import_react232.Children.toArray(items.map(renderItemWithId))) : null;
  const context = {
  ...
  return import_react232.default.createElement(ResourceListContext.Provider, {
    value: context
...
function SettingToggle({
  ...
  const id = (0, import_react233.useMemo)(getUniqueSettingToggleId, []);
  ...
  return import_react233.default.createElement(Card, {
    sectioned: true
  }, import_react233.default.createElement(SettingAction, {
    action: actionMarkup
  }, import_react233.default.createElement("label", {
    htmlFor: id
  }, children2)));
}
...
function SkeletonBodyText({
  ...
  for (let i = 0; i < lines; i++) {
    bodyTextLines.push(import_react234.default.createElement("div", {
      className: styles109.SkeletonBodyText,
      key: i
    }));
  }
  return import_react234.default.createElement(import_react234.default.Fragment, null, bodyTextLines);
}
...
function SkeletonPage({
  ...
  const titleContent = title ? import_react236.default.createElement("h1", {
    className: styles111.Title
  }, title) : import_react236.default.createElement("div", {
    className: styles111.SkeletonTitle
  });
  const titleMarkup = import_react236.default.createElement("div", {
    className: styles111.TitleWrapper
  }, titleContent);
  const primaryActionMarkup = primaryAction ? import_react236.default.createElement("div", {
    className: styles111.PrimaryAction
  }, import_react236.default.createElement(SkeletonDisplayText, {
    size: "large"
  })) : null;
  const breadcrumbMarkup = breadcrumbs ? import_react236.default.createElement("div", {
    className: styles111.BreadcrumbAction,
    style: {
      width: 60
    }
  }, import_react236.default.createElement(SkeletonBodyText, {
    lines: 1
  })) : null;
  ...
  }, breadcrumbMarkup, import_react236.default.createElement("div", {
    className: styles111.TitleAndPrimaryAction
  }, titleMarkup, primaryActionMarkup)), import_react236.default.createElement("div", {
...
function SkeletonTabs({
  ...
  return import_react237.default.createElement("div", {
    ...
    }, import_react237.default.createElement(SkeletonBodyText, {
      lines: 1
    }));
  }));
}
...
function Tab({
  ...
  const wasSelected = (0, import_react240.useRef)(selected);
  const panelFocused = (0, import_react240.useRef)(false);
  const node = (0, import_react240.useRef)(null);
  ...
  const markup = url ? import_react240.default.createElement(UnstyledLink, {
    id,
    url,
    role: "tab",
    tabIndex,
    ...
    "aria-label": accessibilityLabel,
    onMouseUp: handleMouseUpByBlurring
  }, import_react240.default.createElement("span", {
    className: styles114.Title
  }, children2)) : import_react240.default.createElement("button", {
    id,
    role: "tab",
    type: "button",
    tabIndex,
...
// node_modules/@shopify/polaris/build/esm/components/Tabs/components/TabMeasurer/TabMeasurer.js
var TabMeasurer = (0, import_react241.memo)(function TabMeasurer2({
  selected,
  tabs,
  activator,
  tabToFocus,
  ...
  const containerNode = (0, import_react241.useRef)(null);
  const animationFrame = (0, import_react241.useRef)(null);
  const handleMeasurement = (0, import_react241.useCallback)(() => {
    if (animationFrame.current) {
      cancelAnimationFrame(animationFrame.current);
    }
    animationFrame.current = requestAnimationFrame(() => {
  ...
  const tabsMarkup = tabs.map((tab, index) => {
    return import_react241.default.createElement(Tab, {
      measuring: true,
  ...
  return import_react241.default.createElement("div", {
    className: classname,
    ref: containerNode
  }, import_react241.default.createElement(EventListener, {
    event: "resize",
...
var Item9 = class extends import_react242.PureComponent {
  constructor(...args) {
    super(...args);
    this.context = void 0;
  ...
  render() {
    ...
    const markup = url ? import_react242.default.createElement(UnstyledLink, Object.assign({}, sharedProps, {
      url
    }), children2) : import_react242.default.createElement("button", Object.assign({}, sharedProps, {
      type: "button"
    }), children2);
    return import_react242.default.createElement("li", null, markup);
  }
};
...
function List3({
  ...
  const tabs = disclosureTabs.map(({
    ...
    return import_react243.default.createElement(Item9, Object.assign({
      key: id
    }, tabProps, {
      id,
...
// node_modules/@shopify/polaris/build/esm/components/Tabs/Tabs.js
var TabsInner = class extends import_react244.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      disclosureWidth: 0,
    ...
    this.renderTabMarkup = (tab, index) => {
      ...
      return import_react244.default.createElement(Tab, {
        key: `${index}-${tab.id}`,
        id: tab.id,
  ...
  render() {
    ...
    const panelMarkup = children2 ? tabs.map((_tab, index) => {
      return selected === index ? import_react244.default.createElement(Panel, {
        id: tabs[index].panelID || `${tabs[index].id}-panel`,
        tabID: tabs[index].id,
        key: tabs[index].id
      }, children2) : import_react244.default.createElement(Panel, {
        id: tabs[index].panelID || `${tabs[index].id}-panel`,
        tabID: tabs[index].id,
        key: tabs[index].id,
        hidden: true
    ...
    const disclosureButtonContent = hasCustomDisclosure ? import_react244.default.createElement(import_react244.default.Fragment, null, disclosureText, import_react244.default.createElement(Icon, {
      source: SvgCaretDownMinor,
      color: "subdued"
    ...
    const disclosureButton = import_react244.default.createElement("button", {
      type: "button",
    ...
    const activator = disclosureText ? import_react244.default.createElement("div", {
      className: styles114.TabContainer
    }, disclosureButton) : disclosureButton;
    return import_react244.default.createElement("div", null, import_react244.default.createElement("div", {
      className: styles114.Wrapper
    }, import_react244.default.createElement(TabMeasurer, {
      tabToFocus,
      activator,
      selected,
      tabs,
      siblingTabHasFocus: tabToFocus > -1,
      handleMeasurement: this.handleMeasurement
    }), import_react244.default.createElement("ul", {
      role: "tablist",
      className: classname,
      onFocus: this.handleFocus,
      onBlur: this.handleBlur,
    ...
    }, tabsMarkup, import_react244.default.createElement("li", {
      className: disclosureTabClassName,
      role: "presentation"
    }, import_react244.default.createElement(Popover2, {
      preferredPosition: "below",
      activator,
      active: disclosureActivatorVisible && showDisclosure,
      onClose: this.handleClose,
      autofocusTarget: "first-node"
    }, import_react244.default.createElement(List3, {
...
function Tabs(props) {
  const i18n = useI18n();
  return import_react244.default.createElement(TabsInner, Object.assign({}, props, {
    i18n
  }));
}
...
function Thumbnail({
  ...
  const content = typeof source === "string" ? import_react245.default.createElement(Image, {
    alt,
    source
  }) : import_react245.default.createElement(Icon, {
    accessibilityLabel: alt,
    source
  });
  return import_react245.default.createElement("span", {
    className
  }, content);
}
...
var Toast2 = (0, import_react246.memo)(function Toast3(props) {
...
function SearchDismissOverlay({
  ...
  const node = (0, import_react247.useRef)(null);
  const handleDismiss = (0, import_react247.useCallback)(({
    target
  }) => {
  ...
  return import_react247.default.createElement(import_react247.default.Fragment, null, visible ? import_react247.default.createElement(ScrollLock, null) : null, import_react247.default.createElement("div", {
    ref: node,
...
function Search({
  ...
  const overlayMarkup = visible ? import_react248.default.createElement(SearchDismissOverlay, {
    onDismiss,
    visible: overlayVisible
  }) : null;
  return import_react248.default.createElement(import_react248.default.Fragment, null, overlayMarkup, import_react248.default.createElement("div", {
    className: classNames(styles117.Search, visible && styles117.visible)
  }, import_react248.default.createElement(CustomProperties, {
    colorScheme: "dark"
...
function SearchField({
  ...
  const i18n = useI18n();
  const [forceActive, setForceActive] = (0, import_react249.useState)(false);
  const input = (0, import_react249.useRef)(null);
  ...
  const handleFocus = (0, import_react249.useCallback)(() => onFocus && onFocus(), [onFocus]);
  const handleBlur = (0, import_react249.useCallback)(() => onBlur && onBlur(), [onBlur]);
  const handleClear = (0, import_react249.useCallback)(() => {
    onCancel && onCancel();
    if (!input.current) {
      return;
    }
  ...
  const clearMarkup = value !== "" && import_react249.default.createElement("button", {
    type: "button",
  ...
  }, import_react249.default.createElement(Icon, {
    source: SvgCircleCancelMinor
  }));
  ...
  return import_react249.default.createElement("div", {
    ...
    onFocus: handleFocus,
    onBlur: handleBlur
  }, import_react249.default.createElement(VisuallyHidden, null, import_react249.default.createElement("label", {
    htmlFor: searchId
  }, i18n.translate("Polaris.TopBar.SearchField.search"))), import_react249.default.createElement("input", {
    id: searchId,
    ...
    source: SvgSearchMinor
  })), clearMarkup, import_react249.default.createElement("div", {
...
function MessageIndicator({
  ...
  const indicatorMarkup = active && import_react250.default.createElement("div", {
...
function Message({
  ...
  const badgeMarkup = badge && import_react251.default.createElement(Badge, {
    status: badge.status
  }, badge.content);
  const {
    to,
  ...
  }, import_react251.default.createElement(Popover2.Section, null, import_react251.default.createElement(Stack, {
    vertical: true,
    spacing: "tight"
  }, import_react251.default.createElement(TextContainer, null, import_react251.default.createElement(Heading, null, title, badgeMarkup), import_react251.default.createElement("p", null, description)), import_react251.default.createElement(Link, {
    url: to
  }, linkContent), import_react251.default.createElement(Button, {
    plain: true,
    onClick
  }, actionContent))));
}
...
function Menu(props) {
  ...
  const messageMarkup = message && import_react252.default.createElement(Message, {
    title: message.title,
  ...
  return import_react252.default.createElement(Popover2, {
    activator: import_react252.default.createElement("div", {
...
function UserMenu({
  ...
  const activatorContentMarkup = import_react253.default.createElement(import_react253.default.Fragment, null, import_react253.default.createElement(MessageIndicator, {
    active: showIndicator
  }, import_react253.default.createElement(Avatar, {
    size: "small",
    source: avatar,
    initials: initials && initials.replace(" ", "")
  })), import_react253.default.createElement("span", {
    className: styles120.Details
  }, import_react253.default.createElement("p", {
    className: styles120.Name
  }, name), import_react253.default.createElement("p", {
  ...
  return import_react253.default.createElement(Menu, {
...
var TopBar = function TopBar2({
  ...
  const navigationButtonMarkup = showNavigationToggle ? import_react254.default.createElement("button", {
    type: "button",
    className: iconClassName,
  ...
  let contextMarkup;
  if (contextControl) {
    contextMarkup = import_react254.default.createElement("div", {
    ...
    contextMarkup = import_react254.default.createElement("div", {
      className
    }, import_react254.default.createElement(UnstyledLink, {
      url: logo.url || "",
      className: styles116.LogoLink,
      style: {
        width
      }
    }, import_react254.default.createElement(Image, {
      source: logo.topBarSource || "",
      alt: logo.accessibilityLabel || "",
  ...
  const searchMarkup = searchField ? import_react254.default.createElement(import_react254.default.Fragment, null, searchField, import_react254.default.createElement(Search, {
  ...
  }, navigationButtonMarkup, contextMarkup, import_react254.default.createElement("div", {
    className: styles116.Contents
  }, import_react254.default.createElement("div", {
    className: styles116.SearchField
  }, searchMarkup), import_react254.default.createElement("div", {
...
function VideoThumbnail({
  ...
  const timeStampMarkup = videoLength ? import_react255.default.createElement("p", {
  ...
  if (showVideoProgress) {
    ...
    progressMarkup = import_react255.default.createElement("div", {
      className: styles124.Progress
    }, import_react255.default.createElement("progress", {
  ...
  }, import_react255.default.createElement("img", {
...
function useRowHovered() {
  const hovered = (0, import_react256.useContext)(RowHoveredContext);
  return hovered;
}
function useRowSelected() {
  const {
    selected
  } = (0, import_react256.useContext)(RowContext);
  return selected;
}
function useContainerScroll() {
  const scrolledContainerRef = (0, import_react256.useContext)(ScrollContext);
