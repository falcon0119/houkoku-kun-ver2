...
var require_ContextualSaveBar2 = __commonJS({
  "node_modules/@shopify/app-bridge-react/components/ContextualSaveBar/ContextualSaveBar.js"(exports) {
    ...
    var Action = actions_1.ContextualSaveBar.Action;
    var create = actions_1.ContextualSaveBar.create;
    function ContextualSaveBar(_a) {
      var _b = _a.discardAction, discardAction = _b === void 0 ? { onAction: function() {
        return null;
      } } : _b, _c = _a.saveAction, saveAction = _c === void 0 ? { onAction: function() {
        return null;
      } } : _c, fullWidth = _a.fullWidth, leaveConfirmationDisable = _a.leaveConfirmationDisable, visible = _a.visible;
...
var require_Provider = __commonJS({
  "node_modules/@shopify/app-bridge-react/components/Provider/Provider.js"(exports) {
    ...
    function Provider(_a) {
      ...
      return react_1.default.createElement(context_1.AppBridgeContext.Provider, { value: app }, routerMarkup, children);
    }
  ...
  "node_modules/@shopify/app-bridge-react/components/ResourcePicker/ResourcePicker.js"(exports) {
    ...
    function ResourcePicker(props) {
      ...
      react_1.useEffect(function() {
        ...
        if (!wasOpen && open) {
          focusReturnPoint.current = document.activeElement;
        } else if (wasOpen && !open && focusReturnPoint.current != null && document.contains(focusReturnPoint.current)) {
          focusReturnPoint.current.focus();
          focusReturnPoint.current = null;
        }
      }, [open]);
      ...
      react_1.useEffect(function() {
        var shouldUpdate = JSON.stringify(__assign(__assign({}, prevProps.current), { open: void 0 })) !== JSON.stringify(__assign(__assign({}, props), { open: void 0 }));
        if (!shouldUpdate) {
          return;
        }
...
var require_TitleBar2 = __commonJS({
  "node_modules/@shopify/app-bridge-react/components/TitleBar/TitleBar.js"(exports) {
    ...
    function TitleBar(props) {
      ...
      var app = useAppBridge_1.useAppBridge();
      var currentProps = react_1.useRef({ title });
    ...
    function updateSecondaryActions(titleBar, secondaryActions) {
      ...
      secondaryButtons === null || secondaryButtons === void 0 ? void 0 : secondaryButtons.forEach(function(secondaryButton, index) {
        return updateButton(secondaryActions === null || secondaryActions === void 0 ? void 0 : secondaryActions[index], secondaryButton);
      });
    }
...
var require_unstable_Picker = __commonJS({
  "node_modules/@shopify/app-bridge-react/components/unstable_Picker/unstable_Picker.js"(exports) {
    ...
    function Picker(props) {
      ...
      var prevProps = react_1.useRef({ open: false });
      var picker = react_1.useMemo(function() {
        return Picker_1.create(app, getActionOptions(props));
      }, [app]);
      react_1.useEffect(function() {
        var _a;
      ...
      var saveAction = react_1.useMemo(function() {
        return {
          setOptions: function(_a2) {
            ...
            if (Object.keys(saveAction2).length) {
              contextualSaveBar.set({ saveAction: saveAction2 });
            }
          }
        };
      }, [contextualSaveBar]);
      var discardAction = react_1.useMemo(function() {
        return {
          setOptions: function(_a2) {
            ...
            if (Object.keys(discardAction2).length) {
              contextualSaveBar.set({ discardAction: discardAction2 });
            }
          }
        };
      }, [contextualSaveBar]);
